...
sre.MathspeakSpanishTest.prototype.testSample_1_1_2 = function() {
  ...
  this.executeRuleTest(mml, '102 mas 2214 mas 15 igual 2331', 'spanish');
};
...
sre.MathspeakSpanishTest.prototype.testSample_1_4_3 = function() {
  var mml = '<mrow><mn>0x15FF</mn><mo>+</mo><mn>0x2B01</mn><mo>=</mo>' +
      '<mn>0x4100</mn></mrow>';
  this.executeRuleTest(mml, 'número 0 x 1 4 F F mas número 0 x 2 B 0 1 igual número 0 x 4 1 0 0 ', 'spanish');
};
...
sre.MathspeakSpanishTest.prototype.testSample_6_2_2 = function() {
  ...
  this.executeRuleTest(mml, 'abrir valor absoluto a mas menos abrir valor absoluto b menos c cerrar valor absoluto cerrar valor absoluto no es igual a abrir valor absoluto a cerrar valor absoluto mas menos abrir valor absoluto b menos c cerrar valor absoluto', 'spanish');
};
...
sre.MathspeakSpanishTest.prototype.testSample_15_2_1 = function() {
  var mml = '<mrow><mfenced open="|" close="|"><mtable><mtr><mtd><mrow>' +
      ...
      '</mrow>';
  this.executeRuleTest(mml, 'Empezar Determinante 2 por 2 primera fila primera columna a mas 1 segunda columna b segunda fila primera columna c segunda columna d finalizar determinante igual paréntesis izquierdo a mas 1 paréntesis derecho d menos bc', 'spanish');
};
