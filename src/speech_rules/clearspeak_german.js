...
sre.ClearspeakGerman = {
  ...
  ['defineRulesAlias', 'lines-none', 'self::multiline',
      'contains(@grammar, "layoutSummary")'],
  ['defineRulesAlias', 'lines-none', 'self::cases',
      'contains(@grammar, "layoutSummary")'],
