...
(add-hook 'js2-mode-hook
          '(lambda ()
             ...
             (local-set-key "\C-ch" 'js2-compare-actual-expected)
             ))
...
*** Pausing commata:
    ImpTimes007, ImpTimes015, ImpTimes024, ImpTimes025, ImpTimes026, ImpTimes027, ImpTimes035, 
...
*** Pausing Commata, semi-colons, periods:
    Matrix009, Matrix010, Matrix015, Matrix016, Matrix134, Matrix015, Matrix023, Matrix018, Matrix019b, Matrix023, 
