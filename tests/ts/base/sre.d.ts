...
// declare namespace sre.SpeechRule {
//   // export interface Component {
//   //   fromString(str: string): void;
//   //   grammarFromString(str: string): void;
//   //   attributesFromString(str: string): void;
//   // }

//   export declare type Component

//   export function getAttributes(): string[];
//   export function grammarToString(): string;
//   export function attributesToString(): string;
//   export function components(): sre.SpeechRule.Component;


// }

declare namespace sre.SpeechRule.Component {
  export function fromString(str: string): sre.SpeechRule;
  export function grammarFromString(str: string): void;
...
declare namespace xmldom {
  export function XMLSerializer(): string;
  export function DOMParser(str: string): Node;
}
