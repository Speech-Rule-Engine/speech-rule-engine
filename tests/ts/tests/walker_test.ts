...
export class WalkerTest extends AbstractTest {
  ...
  static QUADRATIC_MML:string;


  static QUADRATIC_HTML_CSS:string;


  static QUADRATIC_COMMON_HTML:string;


  static QUADRATIC_SVG:string;


  static EQUATION_MML:string;


  static EQUATION_HTML_CSS:string;


  static EQUATION_COMMON_HTML:string;


  static EQUATION_SVG:string;
   ...
   * Test for syntax walker on MML elements.
   */ 
  testSyntaxWalkerQuadraticMmlCss() {
    let walker = this.createWalker_(
   ...
   */ 
  testSyntaxWalkerQuadraticHtmlCss() {
    let walker = this.createWalker_(
   ...
   */ 
  testSyntaxWalkerQuadraticCommonHtml() {
    let walker = this.createWalker_(
   ...
   */ 
  testSemanticWalkerQuadraticMml() {
    let walker = this.createWalker_(
   ...
   * Test for semantic walker on MML elements.
   */ 
  testSemanticWalkerQuadraticMmlCss() {
    let walker = this.createWalker_(
   ...
   */ 
  testSemanticWalkerQuadraticHtmlCss() {
    let walker = this.createWalker_(
   ...
   */ 
  testSemanticWalkerQuadraticCommonHtml() {
    let walker = this.createWalker_(
   ...
   */ 
  testSemanticWalkerQuadraticSvg() {
    let walker = this.createWalker_(
   ...
   * Test for dummy walker on MML elements.
   */ 
  testDummyWalkerQuadraticMmlCss() {
    let walker = this.createWalker_(
   ...
   */ 
  testDummyWalkerQuadraticHtmlCss() {
    let walker = this.createWalker_(
   ...
   */ 
  testDummyWalkerQuadraticCommonHtml() {
    let walker = this.createWalker_(
   ...
   * Test for syntax walker on MML elements.
   */ 
  testSyntaxWalkerEquationMmlCss() {
    let walker = this.createWalker_(
   ...
   * Test for syntax walker on HTML CSS elements.
   */ 
  testSyntaxWalkerEquationHtmlCss() {
    let walker = this.createWalker_(
   ...
   * Test for syntax walker on Common HTML elements.
   */ 
  testSyntaxWalkerEquationCommonHtml() {
    let walker = this.createWalker_(
   ...
   * Test for semantic walker on MML elements.
   */ 
  testSemanticWalkerEquationMmlCss() {
    let walker = this.createWalker_(
   ...
   * Test for semantic walker on HTML CSS elements.
   */ 
  testSemanticWalkerEquationHtmlCss() {
    let walker = this.createWalker_(
   ...
   * Test for semantic walker on Common HTML elements.
   */ 
  testSemanticWalkerEquationCommonHtml() {
    let walker = this.createWalker_(
   ...
   * Test for dummy walker on HTML CSS elements.
   */ 
  testDummyWalkerEquationHtmlCss() {
    let walker = this.createWalker_(
   ...
   * Test for dummy walker on Common HTML elements.
   */ 
  testDummyWalkerEquationCommonHtml() {
    let walker = this.createWalker_(
   ...
   */ 
  testTableWalkerEquationHtmlCss() {
    let walker = this.createWalker_(
   ...
   */ 
  testTableWalkerEquationCommonHtml() {
    let walker = this.createWalker_(
