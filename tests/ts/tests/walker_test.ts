...
export class WalkerTest extends AbstractTest {
  ...
  public static QUADRATIC_MML: string;

  public static QUADRATIC_HTML_CSS: string;

  public static QUADRATIC_COMMON_HTML: string;

  public static QUADRATIC_SVG: string;

  public static EQUATION_MML: string;

  public static EQUATION_HTML_CSS: string;

  public static EQUATION_COMMON_HTML: string;

  public static EQUATION_SVG: string;

  public information = 'Walker function test.';

  public system = sre.System.getInstance();
   ...
   */
  public testSyntaxWalkerQuadraticMml() {
    let walker = this.createWalker_(
   ...
   * Test for syntax walker on MML elements.
   */
  public testSyntaxWalkerQuadraticMmlCss() {
    let walker = this.createWalker_(
   ...
   */
  public testSyntaxWalkerQuadraticHtmlCss() {
    let walker = this.createWalker_(
   ...
   */
  public testSyntaxWalkerQuadraticCommonHtml() {
    let walker = this.createWalker_(
   ...
   */
  public testSyntaxWalkerQuadraticSvg() {
    let walker = this.createWalker_(
   ...
   */
  public testSemanticWalkerQuadraticMml() {
    let walker = this.createWalker_(
   ...
   * Test for semantic walker on MML elements.
   */
  public testSemanticWalkerQuadraticMmlCss() {
    let walker = this.createWalker_(
   ...
   */
  public testSemanticWalkerQuadraticHtmlCss() {
    let walker = this.createWalker_(
   ...
   */
  public testSemanticWalkerQuadraticCommonHtml() {
    let walker = this.createWalker_(
   ...
   */
  public testSemanticWalkerQuadraticSvg() {
    let walker = this.createWalker_(
   ...
   */
  public testDummyWalkerQuadraticMml() {
    let walker = this.createWalker_(
   ...
   * Test for dummy walker on MML elements.
   */
  public testDummyWalkerQuadraticMmlCss() {
    let walker = this.createWalker_(
   ...
   */
  public testDummyWalkerQuadraticHtmlCss() {
    let walker = this.createWalker_(
   ...
   */
  public testDummyWalkerQuadraticCommonHtml() {
    let walker = this.createWalker_(
   ...
   */
  public testDummyWalkerQuadraticSvg() {
    let walker = this.createWalker_(
   ...
   * Test for syntax walker on MML elements.
   */
  public testSyntaxWalkerEquationMml() {
    let walker = this.createWalker_(
      'Syntax', this.equation.mml, {renderer: 'NativeMML'},
      WalkerTest.EQUATION_MML);
   ...
   * Test for syntax walker on MML elements.
   */
  public testSyntaxWalkerEquationMmlCss() {
    let walker = this.createWalker_(
   ...
   * Test for syntax walker on HTML CSS elements.
   */
  public testSyntaxWalkerEquationHtmlCss() {
    let walker = this.createWalker_(
   ...
   * Test for syntax walker on Common HTML elements.
   */
  public testSyntaxWalkerEquationCommonHtml() {
    let walker = this.createWalker_(
   ...
   * Test for syntax walker on SVG elements.
   */
  public testSyntaxWalkerEquationSvg() {
    let walker = this.createWalker_(
   ...
   * Test for semantic walker on MML elements.
   */
  public testSemanticWalkerEquationMml() {
    let walker = this.createWalker_(
   ...
   * Test for semantic walker on MML elements.
   */
  public testSemanticWalkerEquationMmlCss() {
    let walker = this.createWalker_(
   ...
   * Test for semantic walker on HTML CSS elements.
   */
  public testSemanticWalkerEquationHtmlCss() {
    let walker = this.createWalker_(
   ...
   * Test for semantic walker on Common HTML elements.
   */
  public testSemanticWalkerEquationCommonHtml() {
    let walker = this.createWalker_(
   ...
   * Test for semantic walker on SVG elements.
   */
  public testSemanticWalkerEquationSvg() {
    let walker = this.createWalker_(
   ...
   * Test for dummy walker on MML elements.
   */
  public testDummyWalkerEquationMml() {
    let walker = this.createWalker_(
   ...
   * Test for dummy walker on MML elements.
   */
  public testDummyWalkerEquationMmlCss() {
    let walker = this.createWalker_(
   ...
   * Test for dummy walker on HTML CSS elements.
   */
  public testDummyWalkerEquationHtmlCss() {
    let walker = this.createWalker_(
   ...
   * Test for dummy walker on Common HTML elements.
   */
  public testDummyWalkerEquationCommonHtml() {
    let walker = this.createWalker_(
   ...
   * Test for dummy walker on SVG elements.
   */
  public testDummyWalkerEquationSvg() {
    let walker = this.createWalker_(
   ...
   */
  public testTableWalkerEquationMml() {
    let walker = this.createWalker_(
   ...
   * Test for table walker on MML elements.
   */
  public testTableWalkerEquationMmlCss() {
    let walker = this.createWalker_(
   ...
   */
  public testTableWalkerEquationHtmlCss() {
    let walker = this.createWalker_(
   ...
   */
  public testTableWalkerEquationCommonHtml() {
    let walker = this.createWalker_(
   ...
   */
  public testTableWalkerEquationSvg() {
    let walker = this.createWalker_(
   ...
   */
  private executeTest_(walker: sret.Walker,
                       move: string | number | null, result: string | null) {
    if (move) {
      walker.move(typeof move === 'string' ?
        sre.EventUtil.KeyCode[move] : move);
    }
   ...
   */
  private createWalker_(
    type: string, node: Node, renderer: {renderer: string, browser?: string},
    mml: string): sret.Walker {
  ...
  private executeSummaryQuadraticTest_(node: Node) {
    let dummy = sre.WalkerFactory.walker(
      ...
      (sre.HighlighterFactory.highlighter(
        ...
        {renderer: 'NativeMML'}) as sret.Highlighter),
      WalkerTest.QUADRATIC_MML);
 ...
 */
WalkerTest.QUADRATIC_COMMON_HTML =
 ...
 */
WalkerTest.EQUATION_COMMON_HTML =
