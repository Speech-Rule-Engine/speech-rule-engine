...
/**
 * @fileoverview Test simple annotations for ClearspeakFrench.
 * @author Volker.Sorge@gmail.com (Volker Sorge)
 */

goog.provide('sre.ClearspeakFrenchAnnotationTest');

goog.require('sre.AbstractTest');
goog.require('sre.ClearspeakFrenchUtil');
 ...
 */
sre.ClearspeakFrenchAnnotationTest = function() {
  sre.ClearspeakFrenchAnnotationTest.base(this, 'constructor');

  /**
   * @override
   */
  this.information = 'ClearspeakFrench Simple Expression tests.';

  this.annotator = sre.ClearspeakFrenchUtil.simpleExpression();

};
goog.inherits(sre.ClearspeakFrenchAnnotationTest, sre.AbstractTest);


/**
 * Tests simple annotator for ClearspeakFrench.
 * @param {string} mml Snippet of a MathML expression.
 * @param {boolean} expected The expression is simple or not.
 */
sre.ClearspeakFrenchAnnotationTest.prototype.executeTest = function(mml, expected) {
 ...
 * Test numbers.
 */
sre.ClearspeakFrenchAnnotationTest.prototype.testNumbers = function() {
 ...
 * Test letters.
 */
sre.ClearspeakFrenchAnnotationTest.prototype.testLetters = function() {
 ...
 */
sre.ClearspeakFrenchAnnotationTest.prototype.testMixed = function() {
 ...
 */
sre.ClearspeakFrenchAnnotationTest.prototype.testDegree = function() {
 ...
 */
sre.ClearspeakFrenchAnnotationTest.prototype.testFunctions = function() {
  ...
  this.executeTest('<mi>sin</mi><mo>(</mo><mo>-</mo><mi>x</mi><mi>y</mi>' +
                   '<mo>)</mo>', true);
  this.executeTest('<mi>sin</mi><mo>(</mo><mi>x</mi>', false);
 ...
 */
sre.ClearspeakFrenchAnnotationTest.prototype.testNegativeNumbers = function() {
 ...
 */
sre.ClearspeakFrenchAnnotationTest.prototype.testNegativeLetters = function() {
 ...
 */
sre.ClearspeakFrenchAnnotationTest.prototype.testNegativeMixed = function() {
