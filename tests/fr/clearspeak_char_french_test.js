...
sre.ClearspeakCharFrenchTest.prototype.testClearspeakChars = function() {
  ...
  this.executeCharTest('⁰', ['exposant 0']);
  this.executeCharTest('¹', ['exposant 1']);
  this.executeCharTest('²', ['au carré']);
  this.executeCharTest('³', ['cubique']);
  this.executeCharTest('⁴', ['exposant 4']);
  this.executeCharTest('⁵', ['exposant 5']);
  this.executeCharTest('⁶', ['exposant 6']);
  this.executeCharTest('⁷', ['exposant 7']);
  this.executeCharTest('⁸', ['exposant 8']);
  this.executeCharTest('⁹', ['exposant 9']);
  this.executeCharTest('₀', ['indice 0']);
  this.executeCharTest('₁', ['indice 1']);
  this.executeCharTest('₂', ['indice 2']);
  this.executeCharTest('₃', ['indice 3']);
  this.executeCharTest('₄', ['indice 4']);
  this.executeCharTest('₅', ['indice 5']);
  this.executeCharTest('₆', ['indice 6']);
  this.executeCharTest('₇', ['indice 7']);
  this.executeCharTest('₈', ['indice 8']);
  this.executeCharTest('₉', ['indice 9']);
  this.executeCharTest('⓪', ['0 encerclé']);
  this.executeCharTest('①', ['1 encerclé']);
  this.executeCharTest('②', ['2 encerclé']);
  this.executeCharTest('③', ['3 encerclé']);
  this.executeCharTest('④', ['4 encerclé']);
  this.executeCharTest('⑤', ['5 encerclé']);
  this.executeCharTest('⑥', ['6 encerclé']);
  this.executeCharTest('⑦', ['7 encerclé']);
  this.executeCharTest('⑧', ['8 encerclé']);
  this.executeCharTest('⑨', ['9 encerclé']);
  this.executeCharTest('⑩', ['10 encerclé']);
  this.executeCharTest('⑪', ['11 encerclé']);
  this.executeCharTest('⑫', ['12 encerclé']);
  this.executeCharTest('⑬', ['13 encerclé']);
  this.executeCharTest('⑭', ['14 encerclé']);
  this.executeCharTest('⑮', ['15 encerclé']);
  this.executeCharTest('⑯', ['16 encerclé']);
  this.executeCharTest('⑰', ['17 encerclé']);
  this.executeCharTest('⑱', ['18 encerclé']);
  this.executeCharTest('⑲', ['19 encerclé']);
  this.executeCharTest('⑳', ['20 encerclé']);
  this.executeCharTest('㉑', ['21 encerclé']);
  this.executeCharTest('㉒', ['22 encerclé']);
  this.executeCharTest('㉓', ['23 encerclé']);
  this.executeCharTest('㉔', ['24 encerclé']);
  this.executeCharTest('㉕', ['25 encerclé']);
  this.executeCharTest('㉖', ['26 encerclé']);
  this.executeCharTest('㉗', ['27 encerclé']);
  this.executeCharTest('㉘', ['28 encerclé']);
  this.executeCharTest('㉙', ['29 encerclé']);
  this.executeCharTest('㉚', ['30 encerclé']);
  this.executeCharTest('㉛', ['31 encerclé']);
  this.executeCharTest('㉜', ['32 encerclé']);
  this.executeCharTest('㉝', ['33 encerclé']);
  this.executeCharTest('㉞', ['34 encerclé']);
  this.executeCharTest('㉟', ['35 encerclé']);
  this.executeCharTest('㊱', ['36 encerclé']);
  this.executeCharTest('㊲', ['37 encerclé']);
  this.executeCharTest('㊳', ['38 encerclé']);
  this.executeCharTest('㊴', ['39 encerclé']);
  this.executeCharTest('㊵', ['40 encerclé']);
  this.executeCharTest('㊶', ['41 encerclé']);
  this.executeCharTest('㊷', ['42 encerclé']);
  this.executeCharTest('㊸', ['43 encerclé']);
  this.executeCharTest('㊹', ['44 encerclé']);
  this.executeCharTest('㊺', ['45 encerclé']);
  this.executeCharTest('㊻', ['46 encerclé']);
  this.executeCharTest('㊼', ['47 encerclé']);
  this.executeCharTest('㊽', ['48 encerclé']);
  this.executeCharTest('㊾', ['49 encerclé']);
  this.executeCharTest('㊿', ['50 encerclé']);
  this.executeCharTest('⑴', ['1 entre parenthèses']);
  this.executeCharTest('⑵', ['2 entre parenthèses']);
  this.executeCharTest('⑶', ['3 entre parenthèses']);
  this.executeCharTest('⑷', ['4 entre parenthèses']);
  this.executeCharTest('⑸', ['5 entre parenthèses']);
  this.executeCharTest('⑹', ['6 entre parenthèses']);
  this.executeCharTest('⑺', ['7 entre parenthèses']);
  this.executeCharTest('⑻', ['8 entre parenthèses']);
  this.executeCharTest('⑼', ['9 entre parenthèses']);
  this.executeCharTest('⑽', ['10 entre parenthèses']);
  this.executeCharTest('⑾', ['11 entre parenthèses']);
  this.executeCharTest('⑿', ['12 entre parenthèses']);
  this.executeCharTest('⒀', ['13 entre parenthèses']);
  this.executeCharTest('⒁', ['14 entre parenthèses']);
  this.executeCharTest('⒂', ['15 entre parenthèses']);
  this.executeCharTest('⒃', ['16 entre parenthèses']);
  this.executeCharTest('⒄', ['17 entre parenthèses']);
  this.executeCharTest('⒅', ['18 entre parenthèses']);
  this.executeCharTest('⒆', ['19 entre parenthèses']);
  this.executeCharTest('⒇', ['20 entre parenthèses']);
  this.executeCharTest('🄀', ['0 un point']);
  this.executeCharTest('⒈', ['1 un point']);
  this.executeCharTest('⒉', ['2 un point']);
  this.executeCharTest('⒊', ['3 un point']);
  this.executeCharTest('⒋', ['4 un point']);
  this.executeCharTest('⒌', ['5 un point']);
  this.executeCharTest('⒍', ['6 un point']);
  this.executeCharTest('⒎', ['7 un point']);
  this.executeCharTest('⒏', ['8 un point']);
  this.executeCharTest('⒐', ['9 un point']);
  this.executeCharTest('⒑', ['10 un point']);
  this.executeCharTest('⒒', ['11 un point']);
  this.executeCharTest('⒓', ['12 un point']);
  this.executeCharTest('⒔', ['13 un point']);
  this.executeCharTest('⒕', ['14 un point']);
  this.executeCharTest('⒖', ['15 un point']);
  this.executeCharTest('⒗', ['16 un point']);
  this.executeCharTest('⒘', ['17 un point']);
  this.executeCharTest('⒙', ['18 un point']);
  this.executeCharTest('⒚', ['19 un point']);
  this.executeCharTest('⒛', ['20 un point']);
  this.executeCharTest('⓿', ['0 encerclé noir']);
  this.executeCharTest('❶', ['1 encerclé noir']);
  this.executeCharTest('❷', ['2 encerclé noir']);
  this.executeCharTest('❸', ['3 encerclé noir']);
  this.executeCharTest('❹', ['4 encerclé noir']);
  this.executeCharTest('❺', ['5 encerclé noir']);
  this.executeCharTest('❻', ['6 encerclé noir']);
  this.executeCharTest('❼', ['7 encerclé noir']);
  this.executeCharTest('❽', ['8 encerclé noir']);
  this.executeCharTest('❾', ['9 encerclé noir']);
  this.executeCharTest('❿', ['10 encerclé noir']);
  this.executeCharTest('⓫', ['11 encerclé noir']);
  this.executeCharTest('⓬', ['12 encerclé noir']);
  this.executeCharTest('⓭', ['13 encerclé noir']);
  this.executeCharTest('⓮', ['14 encerclé noir']);
  this.executeCharTest('⓯', ['15 encerclé noir']);
  this.executeCharTest('⓰', ['16 encerclé noir']);
  this.executeCharTest('⓱', ['17 encerclé noir']);
  this.executeCharTest('⓲', ['18 encerclé noir']);
  this.executeCharTest('⓳', ['19 encerclé noir']);
  this.executeCharTest('⓴', ['20 encerclé noir']);
  this.executeCharTest('⓵', ['1 encerclé double']);
  this.executeCharTest('⓶', ['2 encerclé double']);
  this.executeCharTest('⓷', ['3 encerclé double']);
  this.executeCharTest('⓸', ['4 encerclé double']);
  this.executeCharTest('⓹', ['5 encerclé double']);
  this.executeCharTest('⓺', ['6 encerclé double']);
  this.executeCharTest('⓻', ['7 encerclé double']);
  this.executeCharTest('⓼', ['8 encerclé double']);
  this.executeCharTest('⓽', ['9 encerclé double']);
  this.executeCharTest('⓾', ['10 encerclé double']);
  this.executeCharTest('🄋', ['0 sans empattement encerclé']);
  this.executeCharTest('➀', ['1 sans empattement encerclé']);
  this.executeCharTest('➁', ['2 sans empattement encerclé']);
  this.executeCharTest('➂', ['3 sans empattement encerclé']);
  this.executeCharTest('➃', ['4 sans empattement encerclé']);
  this.executeCharTest('➄', ['5 sans empattement encerclé']);
  this.executeCharTest('➅', ['6 sans empattement encerclé']);
  this.executeCharTest('➆', ['7 sans empattement encerclé']);
  this.executeCharTest('➇', ['8 sans empattement encerclé']);
  this.executeCharTest('➈', ['9 sans empattement encerclé']);
  this.executeCharTest('➉', ['10 sans empattement encerclé']);
  this.executeCharTest('🄌', ['0 sans empattement encerclé noir']);
  this.executeCharTest('➊', ['1 sans empattement encerclé noir']);
  this.executeCharTest('➋', ['2 sans empattement encerclé noir']);
  this.executeCharTest('➌', ['3 sans empattement encerclé noir']);
  this.executeCharTest('➍', ['4 sans empattement encerclé noir']);
  this.executeCharTest('➎', ['5 sans empattement encerclé noir']);
  this.executeCharTest('➏', ['6 sans empattement encerclé noir']);
  this.executeCharTest('➐', ['7 sans empattement encerclé noir']);
  this.executeCharTest('➑', ['8 sans empattement encerclé noir']);
  this.executeCharTest('➒', ['9 sans empattement encerclé noir']);
  this.executeCharTest('➓', ['10 sans empattement encerclé noir']);
  ...
  this.executeCharTest('𝟎', ['0 en gras']);
  this.executeCharTest('𝟏', ['1 en gras']);
  this.executeCharTest('𝟐', ['2 en gras']);
  this.executeCharTest('𝟑', ['3 en gras']);
  this.executeCharTest('𝟒', ['4 en gras']);
  this.executeCharTest('𝟓', ['5 en gras']);
  this.executeCharTest('𝟔', ['6 en gras']);
  this.executeCharTest('𝟕', ['7 en gras']);
  this.executeCharTest('𝟖', ['8 en gras']);
  this.executeCharTest('𝟗', ['9 en gras']);
  this.executeCharTest('𝟘', ['0 ajouré']);
  this.executeCharTest('𝟙', ['1 ajouré']);
  this.executeCharTest('𝟚', ['2 ajouré']);
  this.executeCharTest('𝟛', ['3 ajouré']);
  this.executeCharTest('𝟜', ['4 ajouré']);
  this.executeCharTest('𝟝', ['5 ajouré']);
  this.executeCharTest('𝟞', ['6 ajouré']);
  this.executeCharTest('𝟟', ['7 ajouré']);
  this.executeCharTest('𝟠', ['8 ajouré']);
  this.executeCharTest('𝟡', ['9 ajouré']);
  this.executeCharTest('𝟢', ['0 sans empattement']);
  this.executeCharTest('𝟣', ['1 sans empattement']);
  this.executeCharTest('𝟤', ['2 sans empattement']);
  this.executeCharTest('𝟥', ['3 sans empattement']);
  this.executeCharTest('𝟦', ['4 sans empattement']);
  this.executeCharTest('𝟧', ['5 sans empattement']);
  this.executeCharTest('𝟨', ['6 sans empattement']);
  this.executeCharTest('𝟩', ['7 sans empattement']);
  this.executeCharTest('𝟪', ['8 sans empattement']);
  this.executeCharTest('𝟫', ['9 sans empattement']);
  this.executeCharTest('𝟬', ['0 en gras sans empattement']);
  this.executeCharTest('𝟭', ['1 en gras sans empattement']);
  this.executeCharTest('𝟮', ['2 en gras sans empattement']);
  this.executeCharTest('𝟯', ['3 en gras sans empattement']);
  this.executeCharTest('𝟰', ['4 en gras sans empattement']);
  this.executeCharTest('𝟱', ['5 en gras sans empattement']);
  this.executeCharTest('𝟲', ['6 en gras sans empattement']);
  this.executeCharTest('𝟳', ['7 en gras sans empattement']);
  this.executeCharTest('𝟴', ['8 en gras sans empattement']);
  this.executeCharTest('𝟵', ['9 en gras sans empattement']);
  this.executeCharTest('𝟶', ['0 en chasse fixe']);
  this.executeCharTest('𝟷', ['1 en chasse fixe']);
  this.executeCharTest('𝟸', ['2 en chasse fixe']);
  this.executeCharTest('𝟹', ['3 en chasse fixe']);
  this.executeCharTest('𝟺', ['4 en chasse fixe']);
  this.executeCharTest('𝟻', ['5 en chasse fixe']);
  this.executeCharTest('𝟼', ['6 en chasse fixe']);
  this.executeCharTest('𝟽', ['7 en chasse fixe']);
  this.executeCharTest('𝟾', ['8 en chasse fixe']);
  this.executeCharTest('𝟿', ['9 en chasse fixe']);
  this.executeCharTest('🄁', ['0 virgule']);
  this.executeCharTest('🄂', ['1 virgule']);
  this.executeCharTest('🄃', ['2 virgule']);
  this.executeCharTest('🄄', ['3 virgule']);
  this.executeCharTest('🄅', ['4 virgule']);
  this.executeCharTest('🄆', ['5 virgule']);
  this.executeCharTest('🄇', ['6 virgule']);
  this.executeCharTest('🄈', ['7 virgule']);
  this.executeCharTest('🄉', ['8 virgule']);
  this.executeCharTest('🄊', ['9 virgule']);
...
sre.ClearspeakCharFrenchTest.prototype.testClearspeakFunctions = function() {
  ...
  this.executeCharTest('hom', ['homomorphisme']);
  this.executeCharTest('Hom', ['homomorphisme']);
  this.executeCharTest('ker', ['noyau']);
  this.executeCharTest('Tr', ['trace']);
  this.executeCharTest('tr', ['trace']);
  this.executeCharTest('log', ['log']);
  this.executeCharTest('ln', ['logarithme népérien']);
  this.executeCharTest('lg', ['logarithme décimal']);
  this.executeCharTest('exp', ['exponentielle']);
  this.executeCharTest('expt', ['exponentielle']);
  this.executeCharTest('gcd', ['pgcd']);
  this.executeCharTest('lcm', ['ppcm']);
  this.executeCharTest('arg', ['argument']);
  this.executeCharTest('im', ['partie imaginaire']);
  this.executeCharTest('re', ['partie réelle']);
  this.executeCharTest('inf', ['borne inférieure']);
  this.executeCharTest('lim', ['limite']);
  this.executeCharTest('lim inf', ['limite inferior']);
  this.executeCharTest('liminf', ['limite inferior']);
  this.executeCharTest('lim sup', ['limite superior']);
  this.executeCharTest('limsup', ['limite superior']);
  this.executeCharTest('max', ['maximum']);
  this.executeCharTest('min', ['minimum']);
  this.executeCharTest('sup', ['borne supérieure']);
  this.executeCharTest('injlim', ['limite inductive']);
  this.executeCharTest('inj lim', ['limite inductive']);
  this.executeCharTest('projlim', ['limite projective']);
  this.executeCharTest('proj lim', ['limite projective']);
  this.executeCharTest('mod', ['modulo']);
  this.executeCharTest('Pr', ['probabilité']);
  ...
  this.executeCharTest('arcosh', ['argument cosinus hyperbolique']);
  this.executeCharTest('arccosh', ['argument cosinus hyperbolique']);
  this.executeCharTest('arcoth', ['argument cotangente hyperbolique']);
  this.executeCharTest('arccoth', ['argument cotangente hyperbolique']);
  this.executeCharTest('arcsch', ['argument cosécante hyperbolique']);
  this.executeCharTest('arccsch', ['argument cosécante hyperbolique']);
  this.executeCharTest('arsech', ['argument sécante hyperbolique']);
  this.executeCharTest('arcsech', ['argument sécante hyperbolique']);
  this.executeCharTest('arsinh', ['argument sinus hyperbolique']);
  this.executeCharTest('arcsinh', ['argument sinus hyperbolique']);
  this.executeCharTest('artanh', ['argument tangente hyperbolique']);
  this.executeCharTest('arctanh', ['argument tangente hyperbolique']);
  ...
  this.executeCharTest('arccos', ['arc cosinus']);
  this.executeCharTest('arccot', ['arc cotangente']);
  this.executeCharTest('arccsc', ['arc cosécante']);
  this.executeCharTest('arcsec', ['arc sécante']);
  this.executeCharTest('arcsin', ['arc sinus']);
  this.executeCharTest('arctan', ['arc tangente']);
};
