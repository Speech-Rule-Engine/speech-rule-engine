...
goog.provide('sre.MathspeakEmbellishFrenchTest');
 ...
 */
sre.MathspeakEmbellishFrenchTest = function() {
  sre.MathspeakEmbellishFrenchTest.base(this, 'constructor');
 ...
 */
sre.MathspeakEmbellishFrenchTest.prototype.testEmbellMultRelSubscript =
    function() {
  var mml = '<mi>a</mi><msub><mo>=</mo><mn>2</mn></msub><mi>b</mi>' +
          '<mo>=</mo><mi>c</mi>';
 ...
 */
sre.MathspeakEmbellishFrenchTest.prototype.testEmbellPunctSubSuper =
    function() {
  var mml = '<mi>a</mi><msubsup><mo>:</mo><mi>m</mi><mn>2</mn>' +
          '</msubsup><mi>b</mi>';
 ...
 */
sre.MathspeakEmbellishFrenchTest.prototype.testEmbellMultPunctSubscript =
    function() {
  var mml = '<mi>a</mi><msub><mo>:</mo><mn>2</mn></msub><mi>b</mi>' +
          '<mo>:</mo><mi>c</mi>';
 ...
 */
sre.MathspeakEmbellishFrenchTest.prototype.testSemanticsElement = function() {
 ...
 */
sre.MathspeakEmbellishFrenchTest.prototype.testSemanticsAnnotation = function()
    {
 ...
 */
sre.MathspeakEmbellishFrenchTest.prototype.testSemanticsAnnotationXml =
    function() {
  // This is not really legal markup.
