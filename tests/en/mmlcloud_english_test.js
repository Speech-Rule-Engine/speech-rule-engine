...
sre.MmlcloudEnglishTest.prototype.testSupBaseRelseq = function() {
  ...
  this.executeRuleTest(mml, 'c 1 h Superscript 4 minus 2 s Baseline' +
                       ' less than or equals StartFraction 1 Over 2' +
                       ' upper T EndFraction less than or equals c 2 h' +
  ...
  this.executeRuleTest(mml, 'c 1 h Sup 4 minus 2 s Base' +
                       ...
                       ' EndFrac less than or equals c 2 h Sup 4 minus 2 s',
                       'brief');
  this.executeRuleTest(mml, 'c 1 h Sup 4 minus 2 s Base less than or equals' +
                       ' Frac 1 Over 2 upper T EndFrac less than or equals' +
...
sre.MmlcloudEnglishTest.prototype.testSupBaseMultirel = function() {
  ...
  this.executeRuleTest(mml, 'c 1 h Superscript 4 minus 2 s Baseline' +
                       ' less than or equals StartFraction 1 Over 2 upper T' +
  ...
  this.executeRuleTest(mml, 'c 1 h Sup 4 minus 2 s Base less than or equals' +
                       ...
                       ' 4 minus 2 s', 'brief');
  this.executeRuleTest(mml, 'c 1 h Sup 4 minus 2 s Base' +
                       ' less than or equals Frac 1 Over 2 upper T EndFrac' +
...
sre.MmlcloudEnglishTest.prototype.testSubBaseRelseq = function() {
  ...
  this.executeRuleTest(mml, 'h Subscript s Baseline less than or equals' +
                       ' StartFraction 1 Over 2 upper T EndFraction' +
                       ' less than or equals h Subscript s', 'default');
  this.executeRuleTest(mml, 'h Sub s Base less than or equals StartFrac' +
                       ' 1 Over 2 upper T EndFrac less than or equals h' +
                       ' Sub s', 'brief');
  this.executeRuleTest(mml, 'h Sub s Base less than or equals Frac 1 Over' +
                       ' 2 upper T EndFrac less than or equals h Sub s',
                       'sbrief');
};
...
sre.MmlcloudEnglishTest.prototype.testSubSuperBaseRelseq = function() {
  ...
  this.executeRuleTest(mml, 'h Subscript s Superscript t Baseline' +
                       ...
                       ' T EndFraction less than or equals h Subscript' +
                       ' s Superscript t', 'default');
  this.executeRuleTest(mml, 'h Sub s Sup t Base less than or equals' +
                       ' StartFrac 1 Over 2 upper T EndFrac' +
                       ' less than or equals h Sub s Sup t', 'brief');
  this.executeRuleTest(mml, 'h Sub s Sup t Base less than or equals Frac' +
                       ' 1 Over 2 upper T EndFrac less than or equals' +
