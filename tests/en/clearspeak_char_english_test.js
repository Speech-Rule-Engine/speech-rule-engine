...
sre.ClearspeakCharEnglishTest.prototype.testClearspeakChars = function() {
  ...
  this.executeCharTest('⁰', ['super 0']);
  this.executeCharTest('⁴', ['super 4']);
  this.executeCharTest('⁵', ['super 5']);
  this.executeCharTest('⁶', ['super 6']);
  this.executeCharTest('⁷', ['super 7']);
  this.executeCharTest('⁸', ['super 8']);
  this.executeCharTest('⁹', ['super 9']);
  this.executeCharTest('₀', ['sub 0']);
  this.executeCharTest('₁', ['sub 1']);
  this.executeCharTest('₂', ['sub 2']);
  this.executeCharTest('₃', ['sub 3']);
  this.executeCharTest('₄', ['sub 4']);
  this.executeCharTest('₅', ['sub 5']);
  this.executeCharTest('₆', ['sub 6']);
  this.executeCharTest('₇', ['sub 7']);
  this.executeCharTest('₈', ['sub 8']);
  this.executeCharTest('₉', ['sub 9']);
  ...
  this.executeCharTest('⓫', ['black circled 11']);
  this.executeCharTest('⓬', ['black circled 12']);
  this.executeCharTest('⓭', ['black circled 13']);
  this.executeCharTest('⓮', ['black circled 14']);
  this.executeCharTest('⓯', ['black circled 15']);
  this.executeCharTest('⓰', ['black circled 16']);
  this.executeCharTest('⓱', ['black circled 17']);
  this.executeCharTest('⓲', ['black circled 18']);
  this.executeCharTest('⓳', ['black circled 19']);
  this.executeCharTest('⓴', ['black circled 20']);
  ...
  this.executeCharTest('⓿', ['black circled 0']);
  this.executeCharTest('❶', ['black circled 1']);
  this.executeCharTest('❷', ['black circled 2']);
  this.executeCharTest('❸', ['black circled 3']);
  this.executeCharTest('❹', ['black circled 4']);
  this.executeCharTest('❺', ['black circled 5']);
  this.executeCharTest('❻', ['black circled 6']);
  this.executeCharTest('❼', ['black circled 7']);
  this.executeCharTest('❽', ['black circled 8']);
  this.executeCharTest('❾', ['black circled 9']);
  this.executeCharTest('❿', ['black circled 10']);
  this.executeCharTest('➀', ['circled sans serif 1']);
  this.executeCharTest('➁', ['circled sans serif 2']);
  this.executeCharTest('➂', ['circled sans serif 3']);
  this.executeCharTest('➃', ['circled sans serif 4']);
  this.executeCharTest('➄', ['circled sans serif 5']);
  this.executeCharTest('➅', ['circled sans serif 6']);
  this.executeCharTest('➆', ['circled sans serif 7']);
  this.executeCharTest('➇', ['circled sans serif 8']);
  this.executeCharTest('➈', ['circled sans serif 9']);
  this.executeCharTest('➉', ['circled sans serif 10']);
  this.executeCharTest('➊', ['black circled sans serif 1']);
  this.executeCharTest('➋', ['black circled sans serif 2']);
  this.executeCharTest('➌', ['black circled sans serif 3']);
  this.executeCharTest('➍', ['black circled sans serif 4']);
  this.executeCharTest('➎', ['black circled sans serif 5']);
  this.executeCharTest('➏', ['black circled sans serif 6']);
  this.executeCharTest('➐', ['black circled sans serif 7']);
  this.executeCharTest('➑', ['black circled sans serif 8']);
  this.executeCharTest('➒', ['black circled sans serif 9']);
  this.executeCharTest('➓', ['black circled sans serif 10']);
  ...
  this.executeCharTest('㉑', ['circled 21']);
  this.executeCharTest('㉒', ['circled 22']);
  this.executeCharTest('㉓', ['circled 23']);
  this.executeCharTest('㉔', ['circled 24']);
  this.executeCharTest('㉕', ['circled 25']);
  this.executeCharTest('㉖', ['circled 26']);
  this.executeCharTest('㉗', ['circled 27']);
  this.executeCharTest('㉘', ['circled 28']);
  this.executeCharTest('㉙', ['circled 29']);
  this.executeCharTest('㉚', ['circled 30']);
  this.executeCharTest('㉛', ['circled 31']);
  this.executeCharTest('㉜', ['circled 32']);
  this.executeCharTest('㉝', ['circled 33']);
  this.executeCharTest('㉞', ['circled 34']);
  this.executeCharTest('㉟', ['circled 35']);
  this.executeCharTest('㊱', ['circled 36']);
  this.executeCharTest('㊲', ['circled 37']);
  this.executeCharTest('㊳', ['circled 38']);
  this.executeCharTest('㊴', ['circled 39']);
  this.executeCharTest('㊵', ['circled 40']);
  this.executeCharTest('㊶', ['circled 41']);
  this.executeCharTest('㊷', ['circled 42']);
  this.executeCharTest('㊸', ['circled 43']);
  this.executeCharTest('㊹', ['circled 44']);
  this.executeCharTest('㊺', ['circled 45']);
  this.executeCharTest('㊻', ['circled 46']);
  this.executeCharTest('㊼', ['circled 47']);
  this.executeCharTest('㊽', ['circled 48']);
  this.executeCharTest('㊾', ['circled 49']);
  this.executeCharTest('㊿', ['circled 50']);
  ...
  this.executeCharTest('𝟘', ['double struck 0']);
  this.executeCharTest('𝟙', ['double struck 1']);
  this.executeCharTest('𝟚', ['double struck 2']);
  this.executeCharTest('𝟛', ['double struck 3']);
  this.executeCharTest('𝟜', ['double struck 4']);
  this.executeCharTest('𝟝', ['double struck 5']);
  this.executeCharTest('𝟞', ['double struck 6']);
  this.executeCharTest('𝟟', ['double struck 7']);
  this.executeCharTest('𝟠', ['double struck 8']);
  this.executeCharTest('𝟡', ['double struck 9']);
  ...
  this.executeCharTest('≠', ['is not equal to']);
  ...
  this.executeCharTest('≨', ['is less than but not equal to']);
  this.executeCharTest('≩', ['is greater than but not equal to']);
  ...
  this.executeCharTest('⋕', ['is equal and parallel to']);
  this.executeCharTest('⋖', ['is less than dot']);
  this.executeCharTest('⋗', ['is greater than dot']);
  this.executeCharTest('⋘', ['is very much less than']);
  this.executeCharTest('⋙', ['is very much greater than']);
  this.executeCharTest('⋚', ['is less than equal to or greater than']);
  this.executeCharTest('⋛', ['is greater than equal to or less than']);
  this.executeCharTest('⋜', ['is equal to or less than']);
  this.executeCharTest('⋝', ['is equal to or greater than']);
  this.executeCharTest('⋞', ['is equal to or precedes']);
  this.executeCharTest('⋟', ['is equal to or succeeds']);
  this.executeCharTest('⋠', ['does not precede or equal']);
  this.executeCharTest('⋡', ['does not succeed or equal']);
  this.executeCharTest('⋢', ['is not square image of or equal to']);
  this.executeCharTest('⋣', ['is not square original of or equal to']);
  this.executeCharTest('⋤', ['is square image of or not equal to']);
  this.executeCharTest('⋥', ['is square original of or not equal to']);
  this.executeCharTest('⋦', ['is less than but not equivalent to']);
  this.executeCharTest('⋧', ['is greater than but not equivalent to']);
  this.executeCharTest('⋨', ['precedes but not equivalent to']);
  this.executeCharTest('⋩', ['succeeds but not equivalent to']);
  this.executeCharTest('⋪', ['is not normal subgroup of']);
  this.executeCharTest('⋫', ['does not contain as normal subgroup']);
  this.executeCharTest('⋬', ['is not normal subgroup of or equal to']);
  ...
  this.executeCharTest('⪪', ['is smaller than']);
  this.executeCharTest('⪫', ['is larger than']);
  this.executeCharTest('⪬', ['is smaller than or equal to']);
  this.executeCharTest('⪭', ['is larger than or equal to']);
