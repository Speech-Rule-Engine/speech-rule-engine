...
sre.DefaultCharEnglishTest.prototype.testDefaultChars = function() {
  ...
  this.executeCharTest('⁡', ['function application']);
  this.executeCharTest('⁢', ['invisible times']);
  this.executeCharTest('⁣', ['invisible separator']);
  this.executeCharTest('⁤', ['invisible plus']);
  ...
  this.executeCharTest('⚪', ['medium white circle']);
  this.executeCharTest('⚫', ['medium black circle']);
  this.executeCharTest('✅', ['white heavy check mark']);
...
sre.DefaultCharEnglishTest.prototype.testDefaultFunctions = function() {
  ...
  this.executeCharTest('tr', ['trace']);
  this.executeCharTest('log', ['logarithm']);
  this.executeCharTest('ln', ['natural logarithm']);
  this.executeCharTest('lg', ['logarithm base 10']);
  ...
  this.executeCharTest('lim inf', ['infimum default']);
  this.executeCharTest('liminf', ['infimum default']);
  this.executeCharTest('lim sup', ['supremum limit']);
  this.executeCharTest('limsup', ['supremum limit']);
  this.executeCharTest('max', ['maximum']);
  this.executeCharTest('min', ['minimum']);
  this.executeCharTest('sup', ['supremum']);
  this.executeCharTest('injlim', ['injective limit']);
  this.executeCharTest('inj lim', ['injective limit']);
  ...
  this.executeCharTest('cosh', ['hyperbolic cosine function']);
  this.executeCharTest('coth', ['hyperbolic cotangent function']);
  this.executeCharTest('csch', ['hyperbolic cosecant function']);
  this.executeCharTest('sech', ['hyperbolic secant function']);
  this.executeCharTest('sinh', ['hyperbolic sine function']);
  this.executeCharTest('tanh', ['hyperbolic tangent function']);
  this.executeCharTest('arcosh', ['inverse hyperbolic cosine function']);
  this.executeCharTest('arccosh', ['inverse hyperbolic cosine function']);
  this.executeCharTest('arcoth', ['inverse hyperbolic cotangent function']);
  this.executeCharTest('arccoth', ['inverse hyperbolic cotangent function']);
  this.executeCharTest('arcsch', ['inverse hyperbolic cosecant function']);
  this.executeCharTest('arccsch', ['inverse hyperbolic cosecant function']);
  this.executeCharTest('arsech', ['inverse hyperbolic secant function']);
  this.executeCharTest('arcsech', ['inverse hyperbolic secant function']);
  this.executeCharTest('arsinh', ['inverse hyperbolic sine function']);
  this.executeCharTest('arcsinh', ['inverse hyperbolic sine function']);
  this.executeCharTest('artanh', ['inverse hyperbolic tangent function']);
  this.executeCharTest('arctanh', ['inverse hyperbolic tangent function']);
  this.executeCharTest('cos', ['cosine function']);
  this.executeCharTest('cosine', ['cosine function']);
  this.executeCharTest('cot', ['cotangent function']);
  this.executeCharTest('csc', ['cosecant function']);
  this.executeCharTest('sec', ['secant function']);
  this.executeCharTest('sin', ['sine function']);
  this.executeCharTest('sine', ['sine function']);
  this.executeCharTest('tan', ['tangent function']);
  this.executeCharTest('arccos', ['inverse cosine function']);
  this.executeCharTest('arccot', ['inverse cotangent function']);
  this.executeCharTest('arccsc', ['inverse cosecant function']);
  this.executeCharTest('arcsec', ['inverse secant function']);
  this.executeCharTest('arcsin', ['inverse sine function']);
  this.executeCharTest('arctan', ['inverse tangent function']);
};
