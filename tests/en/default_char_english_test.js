...
sre.DefaultCharEnglishTest.prototype.testDefaultChars = function() {
  ...
  this.executeCharTest('[', ['left square bracket']);
  this.executeCharTest(']', ['right square bracket']);
  this.executeCharTest('{', ['left curly bracket']);
  this.executeCharTest('}', ['right curly bracket']);
  ...
  this.executeCharTest('⎰', ['upper left or lower right curly bracket section']);
  this.executeCharTest('⎱', ['upper right or lower left curly bracket section']);
  this.executeCharTest('⎲', ['summation top']);
  this.executeCharTest('⎳', ['summation bottom']);
  this.executeCharTest('⎴', ['top square bracket']);
  this.executeCharTest('⎵', ['bottom square bracket']);
  ...
  this.executeCharTest('⏞', ['top curly bracket']);
  this.executeCharTest('⏟', ['bottom curly bracket']);
  ...
  this.executeCharTest('⟦', ['mathematical left white square bracket']);
  this.executeCharTest('⟧', ['mathematical right white square bracket']);
  this.executeCharTest('⟨', ['mathematical left angle bracket']);
  this.executeCharTest('⟩', ['mathematical right angle bracket']);
  this.executeCharTest('⟪', ['mathematical left double angle bracket']);
  this.executeCharTest('⟫', ['mathematical right double angle bracket']);
  ...
  this.executeCharTest('⟮', ['mathematical left flattened parenthesis']);
  this.executeCharTest('⟯', ['mathematical right flattened parenthesis']);
  this.executeCharTest('⦃', ['left white curly bracket']);
  this.executeCharTest('⦄', ['right white curly bracket']);
  this.executeCharTest('⦅', ['left white parenthesis']);
  this.executeCharTest('⦆', ['right white parenthesis']);
  ...
  this.executeCharTest('⦋', ['left square bracket with underbar']);
  this.executeCharTest('⦌', ['right square bracket with underbar']);
  this.executeCharTest('⦍', ['left square bracket with tick in top corner']);
  this.executeCharTest('⦎', ['right square bracket with tick in bottom corner']);
  this.executeCharTest('⦏', ['left square bracket with tick in bottom corner']);
  this.executeCharTest('⦐', ['right square bracket with tick in top corner']);
  ...
  this.executeCharTest('〚', ['left white square bracket']);
  this.executeCharTest('〛', ['right white square bracket']);
  ...
  this.executeCharTest('︷', ['presentation form for vertical left curly bracket']);
  this.executeCharTest('︸', ['presentation form for vertical right curly bracket']);
  ...
  this.executeCharTest('𝟘', ['blackboard zero']);
  this.executeCharTest('𝟙', ['blackboard one']);
  this.executeCharTest('𝟚', ['blackboard two']);
  this.executeCharTest('𝟛', ['blackboard three']);
  this.executeCharTest('𝟜', ['blackboard four']);
  this.executeCharTest('𝟝', ['blackboard five']);
  this.executeCharTest('𝟞', ['blackboard six']);
  this.executeCharTest('𝟟', ['blackboard seven']);
  this.executeCharTest('𝟠', ['blackboard eight']);
  this.executeCharTest('𝟡', ['blackboard nine']);
  ...
  this.executeCharTest('𝟶', ['thin zero']);
  this.executeCharTest('𝟷', ['thin one']);
  this.executeCharTest('𝟸', ['thin two']);
  this.executeCharTest('𝟹', ['thin three']);
  this.executeCharTest('𝟺', ['thin four']);
  this.executeCharTest('𝟻', ['thin five']);
  this.executeCharTest('𝟼', ['thin six']);
  this.executeCharTest('𝟽', ['thin seven']);
  this.executeCharTest('𝟾', ['thin eight']);
  this.executeCharTest('𝟿', ['thin nine']);
  ...
  this.executeCharTest('#', ['number']);
  this.executeCharTest('$', ['dollar']);
  this.executeCharTest('%', ['percent']);
  ...
  this.executeCharTest('.', ['full stop']);
  ...
  this.executeCharTest('_', ['low line']);
  this.executeCharTest('`', ['grave']);
  this.executeCharTest('|', ['vertical line']);
  this.executeCharTest('~', ['tilde']);
  this.executeCharTest('¡', ['inverted exclamation mark']);
  this.executeCharTest('¢', ['cent']);
  this.executeCharTest('£', ['pound']);
  this.executeCharTest('¤', ['currency']);
  this.executeCharTest('¥', ['yen']);
  this.executeCharTest('¦', ['broken bar']);
  this.executeCharTest('§', ['section']);
  this.executeCharTest('¨', ['double dot']);
  this.executeCharTest('©', ['copyright']);
  this.executeCharTest('ª', ['feminine ordinal indicator']);
  this.executeCharTest('«', ['left pointing double angle quotation mark']);
  this.executeCharTest('¬', ['not']);
  this.executeCharTest('®', ['registered']);
  ...
  this.executeCharTest('¶', ['pilcrow']);
  this.executeCharTest('·', ['middle dot']);
  this.executeCharTest('¸', ['cedilla']);
  this.executeCharTest('º', ['masculine ordinal indicator']);
  this.executeCharTest('»', ['right pointing double angle quotation mark']);
  this.executeCharTest('¿', ['inverted question mark']);
  this.executeCharTest('×', ['multiplication']);
  ...
  this.executeCharTest('˜', ['small tilde']);
  this.executeCharTest('˝', ['double acute accent']);
  ...
  this.executeCharTest('‖', ['double vertical line']);
  ...
  this.executeCharTest('‚', ['single low 9 quotation mark']);
  ...
  this.executeCharTest('„', ['double low 9 quotation mark']);
  ...
  this.executeCharTest('…', ['horizontal ellipsis']);
  ...
  this.executeCharTest('‹', ['single left pointing angle quotation mark']);
  this.executeCharTest('›', ['single right pointing angle quotation mark']);
  ...
  this.executeCharTest('∏', ['n ary product']);
  this.executeCharTest('∐', ['n ary coproduct']);
  this.executeCharTest('∑', ['n ary summation']);
  this.executeCharTest('−', ['minus']);
  ...
  this.executeCharTest('∗', ['asterisk operator']);
  this.executeCharTest('∘', ['ring operator']);
  this.executeCharTest('∙', ['bullet operator']);
  ...
  this.executeCharTest('∼', ['tilde operator']);
  ...
  this.executeCharTest('≼', ['precedes or equals']);
  this.executeCharTest('≽', ['succeeds or equals']);
  ...
  this.executeCharTest('⊆', ['subset of or equals']);
  this.executeCharTest('⊇', ['superset of or equals']);
  this.executeCharTest('⊈', ['neither a subset of nor equals']);
  this.executeCharTest('⊉', ['neither a superset of nor equals']);
  ...
  this.executeCharTest('⊑', ['square image of or equals']);
  this.executeCharTest('⊒', ['square original of or equals']);
  ...
  this.executeCharTest('⊙', ['circled dot operator']);
  this.executeCharTest('⊚', ['circled ring operator']);
  this.executeCharTest('⊛', ['circled asterisk operator']);
  ...
  this.executeCharTest('⊡', ['squared dot operator']);
  ...
  this.executeCharTest('⊴', ['normal subgroup of or equals']);
  this.executeCharTest('⊵', ['contains as normal subgroup or equals']);
  ...
  this.executeCharTest('⋀', ['n ary logical and']);
  this.executeCharTest('⋁', ['n ary logical or']);
  this.executeCharTest('⋂', ['n ary intersection']);
  this.executeCharTest('⋃', ['n ary union']);
  this.executeCharTest('⋄', ['diamond operator']);
  this.executeCharTest('⋅', ['dot operator']);
  this.executeCharTest('⋆', ['star operator']);
  ...
  this.executeCharTest('⧣', ['equals sign and slanted parallel']);
  this.executeCharTest('⧤', ['equals sign and slanted parallel with tilde above']);
  ...
  this.executeCharTest('⨌', ['quadruple integral operator']);
  ...
  this.executeCharTest('⨕', ['integral around a point operator']);
  ...
  this.executeCharTest('⩪', ['tilde operator with dot above']);
  ...
  this.executeCharTest('⩳', ['equals above tilde operator']);
  ...
  this.executeCharTest('⪭', ['larger than or equals']);
  this.executeCharTest('⪮', ['equals sign with bumpy above']);
  ...
  this.executeCharTest('⫇', ['subset of above tilde operator']);
  this.executeCharTest('⫈', ['superset of above tilde operator']);
  ...
  this.executeCharTest('⫳', ['parallel with tilde operator']);
  ...
  this.executeCharTest('﹨', ['small reverse solidus']);
