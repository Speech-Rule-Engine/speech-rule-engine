...
sre.MathspeakCharEnglishTest.prototype.testMathspeakChars = function() {
  ...
  this.executeCharTest('〈', ['left pointing angle bracket', 'left pointing angle bracket', 'left pointing angle bracket']);
  this.executeCharTest('〉', ['right pointing angle bracket', 'right pointing angle bracket', 'right pointing angle bracket']);
  ...
  this.executeCharTest('⟨', ['left angle bracket', 'left angle bracket', 'l angle bracket']);
  this.executeCharTest('⟩', ['right angle bracket', 'right angle bracket', 'r angle bracket']);
  this.executeCharTest('⟪', ['left double angle bracket', 'left double angle bracket', 'left double angle bracket']);
  this.executeCharTest('⟫', ['right double angle bracket', 'right double angle bracket', 'right double angle bracket']);
  ...
  this.executeCharTest('⟮', ['flattened left parenthesis', 'flattened left p\'ren', 'flattened L p\'ren']);
  this.executeCharTest('⟯', ['flattened right parenthesis', 'flattened right p\'ren', 'flattened R p\'ren']);
  ...
  this.executeCharTest('⦑', ['left angle bracket with dot', 'left angle bracket with dot', 'l angle bracket with dot']);
  this.executeCharTest('⦒', ['right angle bracket with dot', 'right angle bracket with dot', 'r angle bracket with dot']);
  ...
  this.executeCharTest('︽', ['presentation form for vertical left double angle bracket', 'presentation form for vertical left double angle bracket', 'presentation form for vertical left double angle bracket']);
  this.executeCharTest('︾', ['presentation form for vertical right double angle bracket', 'presentation form for vertical right double angle bracket', 'presentation form for vertical right double angle bracket']);
  this.executeCharTest('︿', ['presentation form for vertical left angle bracket', 'presentation form for vertical left angle bracket', 'presentation form for vertical l angle bracket']);
  this.executeCharTest('﹀', ['presentation form for vertical right angle bracket', 'presentation form for vertical right angle bracket', 'presentation form for vertical r angle bracket']);
  ...
  this.executeCharTest('‗', ['double underline', 'double underline', 'double underline']);
  this.executeCharTest('‘', ['left single quotation mark', 'left single quotation mark', 'left single quotation mark']);
  this.executeCharTest('’', ['right single quotation mark', 'right single quotation mark', 'right single quotation mark']);
  this.executeCharTest('‚', ['low right single quotation mark', 'low right single quotation mark', 'low right single quotation mark']);
  ...
  this.executeCharTest('⁻', ['superscript minus', 'superscript minus', 'superscript minus']);
  this.executeCharTest('⁼', ['superscript equals', 'superscript equals', 'superscript equals']);
  this.executeCharTest('⁽', ['superscript left parenthesis', 'superscript left parenthesis', 'superscript left parenthesis']);
  this.executeCharTest('⁾', ['superscript right parenthesis', 'superscript right parenthesis', 'superscript right parenthesis']);
  this.executeCharTest('₊', ['subscript plus', 'subscript plus', 'subscript plus']);
  this.executeCharTest('₋', ['subscript minus', 'subscript minus', 'subscript minus']);
  this.executeCharTest('₌', ['subscript equals', 'subscript equals', 'subscript equals']);
  this.executeCharTest('₍', ['subscript left parenthesis', 'subscript left parenthesis', 'subscript left parenthesis']);
  this.executeCharTest('₎', ['subscript right parenthesis', 'subscript right parenthesis', 'subscript right parenthesis']);
  ...
  this.executeCharTest('⅌', ['per', 'per', 'per']);
  ...
  this.executeCharTest('∧', ['and', 'and', 'and']);
  this.executeCharTest('∨', ['or', 'or', 'or']);
  ...
  this.executeCharTest('≔', ['colon equals', 'colon equals', 'colon equals']);
  this.executeCharTest('≕', ['equals colon', 'equals colon', 'equals colon']);
  ...
  this.executeCharTest('⋎', ['curly or', 'curly or', 'curly or']);
  this.executeCharTest('⋏', ['curly and', 'curly and', 'curly and']);
  ...
  this.executeCharTest('⟈', ['backslash preceding subset', 'backslash preceding subset', 'backslash preceding subset']);
  ...
  this.executeCharTest('⟋', ['rising diagonal', 'rising diagonal', 'rising diagonal']);
  this.executeCharTest('⟌', ['long division', 'long division', 'long division']);
  this.executeCharTest('⟍', ['falling diagonal', 'falling diagonal', 'falling diagonal']);
  this.executeCharTest('⟎', ['squared and', 'squared and', 'squared and']);
  this.executeCharTest('⟏', ['squared or', 'squared or', 'squared or']);
  ...
  this.executeCharTest('⦸', ['circled backslash', 'circled backslash', 'circled backslash']);
  ...
  this.executeCharTest('⧷', ['backslash with horizontal stroke', 'backslash with horizontal stroke', 'backslash with horizontal stroke']);
  ...
  this.executeCharTest('⨇', ['two and', 'two and', 'two and']);
  this.executeCharTest('⨈', ['two or', 'two or', 'two or']);
  this.executeCharTest('⨉', ['times', 'times', 'times']);
  ...
  this.executeCharTest('⩄', ['intersection with and', 'intersection with and', 'intersection with and']);
  this.executeCharTest('⩅', ['union with or', 'union with or', 'union with or']);
  ...
  this.executeCharTest('⩑', ['and with dot above', 'and with dot above', 'and with dot above']);
  this.executeCharTest('⩒', ['or with dot above', 'or with dot above', 'or with dot above']);
  this.executeCharTest('⩓', ['double and', 'double and', 'double and']);
  this.executeCharTest('⩔', ['double or', 'double or', 'double or']);
  this.executeCharTest('⩕', ['two intersecting and', 'two intersecting and', 'two intersecting and']);
  this.executeCharTest('⩖', ['two intersecting or', 'two intersecting or', 'two intersecting or']);
  ...
  this.executeCharTest('⩙', ['or overlapping and', 'or overlapping and', 'or overlapping and']);
  this.executeCharTest('⩚', ['and with middle stem', 'and with middle stem', 'and with middle stem']);
  this.executeCharTest('⩛', ['or with middle stem', 'or with middle stem', 'or with middle stem']);
  this.executeCharTest('⩜', ['and with horizontal dash', 'and with horizontal dash', 'and with horizontal dash']);
  this.executeCharTest('⩝', ['or with horizontal dash', 'or with horizontal dash', 'or with horizontal dash']);
  this.executeCharTest('⩞', ['and with double overbar', 'and with double overbar', 'and with double overbar']);
  this.executeCharTest('⩟', ['and with underbar', 'and with underbar', 'and with underbar']);
  this.executeCharTest('⩠', ['and with double underbar', 'and with double underbar', 'and with double underbar']);
  this.executeCharTest('⩡', ['small vee with underbar', 'small vee with underbar', 'small vee with underbar']);
  this.executeCharTest('⩢', ['or with double overbar', 'or with double overbar', 'or with double overbar']);
  this.executeCharTest('⩣', ['or with double underbar', 'or with double underbar', 'or with double underbar']);
  ...
  this.executeCharTest('⪭', ['larger than or equal', 'larger than or equal', 'larger than or equal']);
  ...
  this.executeCharTest('︳', ['glyph for vertical underline', 'glyph for vertical underline', 'glyph for vertical underline']);
  this.executeCharTest('︴', ['glyph for vertical wavy underline', 'glyph for vertical wavy underline', 'glyph for vertical wavy underline']);
  ...
  this.executeCharTest('﹉', ['dashed overline', 'dashed overline', 'dashed overline']);
  this.executeCharTest('﹊', ['dash dot overline', 'dash dot overline', 'dash dot overline']);
  this.executeCharTest('﹋', ['wavy overline', 'wavy overline', 'wavy overline']);
  this.executeCharTest('﹌', ['double wavy overline', 'double wavy overline', 'double wavy overline']);
  this.executeCharTest('﹍', ['dashed underline', 'dashed underline', 'dashed underline']);
  this.executeCharTest('﹎', ['dash dot underline', 'dash dot underline', 'dash dot underline']);
  this.executeCharTest('﹏', ['wavy underline', 'wavy underline', 'wavy underline']);
