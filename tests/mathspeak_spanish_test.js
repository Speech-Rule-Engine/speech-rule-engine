...
sre.MathspeakSpanishTest.prototype.testSample_1_4_3 = function() {
  ...
  this.executeRuleTest(mml, 'núm 0 x 1 5 F F más núm 0 x 2 B 0 1 igual núm 0 x 4 1 0 0', 'brief');
  this.executeRuleTest(mml, 'núm 0 x 1 5 F F más núm 0 x 2 B 0 1 igual núm 0 x 4 1 0 0', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_1_5_1 = function() {
  ...
  this.executeRuleTest(mml, 'mayúscula I coma mayúscula I I coma mayúscula I I I coma mayúscula I V coma mayúscula V punto', 'brief');
  this.executeRuleTest(mml, 'mayúscula I coma mayúscula I I coma mayúscula I I I coma mayúscula I V coma mayúscula V punto', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_2_1_1 = function() {
  ...
  this.executeRuleTest(mml, 'd igual empezar raíz cuadrada paréntesis izquierdo mayúscula X menos x paréntesis derecho al cuadrado menos paréntesis izquierdo mayúscula Y menos y paréntesis derecho al cuadrado finalizar raíz cuadrada', 'brief');
  this.executeRuleTest(mml, 'd igual raíz cuadrada paréntesis izquierdo mayúscula X menos x paréntesis derecho al cuadrado menos paréntesis izquierdo mayúscula Y menos y paréntesis derecho al cuadrado finalizar raíz cuadrada', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_2_3_1 = function() {
  ...
  this.executeRuleTest(mml, 'Si mayúscula A flecha derecha mayúscula B y mayúscula B flecha derecha mayúscula C entonces mayúscula A flecha derecha mayúscula C punto', 'brief');
  this.executeRuleTest(mml, 'Si mayúscula A flecha derecha mayúscula B y mayúscula B flecha derecha mayúscula C entonces mayúscula A flecha derecha mayúscula C punto', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_2_6_1 = function() {
  ...
  this.executeRuleTest(mml, 'negrita corchete izquierdo x negrita corchete derecho', 'brief');
  this.executeRuleTest(mml, 'negrita corchete izquierdo x negrita corchete derecho', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_2_6_2 = function() {
  ...
  this.executeRuleTest(mml, 'integral de contorno mayúscula E punto medio d negrita l igual menos empezar frac d mayúscula Phi mayúscula B entre d t finalizar frac', 'brief');
  this.executeRuleTest(mml, 'integral de contorno mayúscula E punto medio d negrita l igual menos frac d mayúscula Phi mayúscula B entre  d t', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testNegativeVsMinus = function() {
  ...
  this.executeRuleTest(mml, 'menos empezar fracción 1 entre b finalizar fracción', 'default');
  mml = '<mrow><mo>-</mo><mfrac><mi>a</mi><mi>b</mi></mfrac></mrow>';
  this.executeRuleTest(mml, 'menos empezar fracción a entre b finalizar fracción', 'default');
  mml = '<mrow><mo>-</mo><mn>3</mn><mfrac><mn>1</mn><mn>2</mn></mfrac></mrow>';
  this.executeRuleTest(mml, 'menos 3 más empezar fracción 1 entre 2 finalizar fracción', 'default');
};
...
sre.MathspeakSpanishTest.prototype.testSample_4_2_1 = function() {
  ...
  this.executeRuleTest(mml, 'Mayúscula paréntesis izquierdo empezar llave alfa coma beta coma gamma coma delta coma épsilon coma phi finalizar llave paréntesis derecho igual empezar llave mayúscula Alfa coma mayúscula Beta coma mayúscula Gamma coma mayúscula Delta coma mayúscula Épsilon coma mayúscula Phi finalizar llave', 'brief');
  this.executeRuleTest(mml, 'Mayúscula paréntesis izquierdo llave alfa coma beta coma gamma coma delta coma épsilon coma phi finalizar llave paréntesis derecho igual llave mayúscula Alfa coma mayúscula Beta coma mayúscula Gamma coma mayúscula Delta coma mayúscula Épsilon coma mayúscula Phi finalizar llave', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_5_1_2 = function() {
  ...
  this.executeRuleTest(mml, 'paréntesis izquierdo 1 a 1 paréntesis derecho', 'brief');
  this.executeRuleTest(mml, 'paréntesis izquierdo 1 a 1 paréntesis derecho', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_6_1_1 = function() {
  ...
  this.executeRuleTest(mml, 'Los números de Fibonacci son dos puntos empezar llave 0 coma 1 coma 1 coma 2 coma 3 coma 5 coma 8 coma puntos suspensivos finalizar llave', 'brief');
  this.executeRuleTest(mml, 'Los números de Fibonacci son dos puntos llave 0 coma 1 coma 1 coma 2 coma 3 coma 5 coma 8 coma puntos suspensivos finalizar llave', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_6_2_1 = function() {
  ...
  this.executeRuleTest(mml, 'empezar valor absoluto 4 menos 7 finalizar valor absoluto igual 3', 'brief');
  this.executeRuleTest(mml, 'valor absoluto 4 menos 7 finalizar valor absoluto igual 3', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_6_2_2 = function() {
  ...
  this.executeRuleTest(mml, 'empezar valor absoluto a más menos empezar valor absoluto b menos c finalizar valor absoluto finalizar valor absoluto no es igual a empezar valor absoluto a finalizar valor absoluto más menos empezar valor absoluto b menos c finalizar valor absoluto', 'brief');
  this.executeRuleTest(mml, 'valor absoluto a más menos valor absoluto b menos c finalizar valor absoluto finalizar valor absoluto no es igual a valor absoluto a finalizar valor absoluto más menos valor absoluto b menos c finalizar valor absoluto', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_7_1_2 = function() {
  ...
  this.executeRuleTest(mml, 'a menos empezar frac b más c entre d menos e finalizar frac por f', 'brief');
  this.executeRuleTest(mml, 'a menos frac b más c entre  d menos e por f', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_7_2_1 = function() {
  ...
  this.executeRuleTest(mml, 'empezar empezar frac empezar frac x entre y finalizar frac entre entre z finalizar finalizar frac no es igual a empezar empezar frac x entre entre empezar frac y entre z finalizar frac finalizar finalizar frac', 'brief');
  this.executeRuleTest(mml, 'frac frac x entre  y sobre z no es igual a frac x sobre frac y entre  z', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_7_3_1 = function() {
  ...
  this.executeRuleTest(mml, 'empezar empezar empezar frac empezar empezar frac paréntesis izquierdo 1 menos x paréntesis derecho empezar frac d entre d x finalizar frac paréntesis izquierdo 2 x paréntesis derecho menos 2 x empezar frac d entre d x finalizar frac paréntesis izquierdo 1 menos x paréntesis derecho entre entre paréntesis izquierdo 1 menos x paréntesis derecho al cuadrado finalizar finalizar frac entre entre entre 1 más paréntesis izquierdo empezar frac 2 x entre 1 menos x finalizar frac paréntesis derecho al cuadrado finalizar finalizar finalizar frac', 'brief');
  this.executeRuleTest(mml, 'frac frac paréntesis izquierdo 1 menos x paréntesis derecho frac d entre  d x paréntesis izquierdo 2 x paréntesis derecho menos 2 x frac d entre  d x paréntesis izquierdo 1 menos x paréntesis derecho sobre paréntesis izquierdo 1 menos x paréntesis derecho al cuadrado sobre 1 más paréntesis izquierdo frac 2 x entre  1 menos x paréntesis derecho al cuadrado', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_7_3_2 = function() {
  ...
  this.executeRuleTest(mml, 'a sub 0 más empezar empezar empezar empezar frac 1 entre entre entre entre a sub 1 más empezar empezar empezar frac 1 entre entre entre a sub 2 más empezar empezar frac 1 entre entre puntos suspensivos más empezar frac 1 entre a sub n finalizar frac finalizar finalizar frac finalizar finalizar finalizar frac finalizar finalizar finalizar finalizar frac', 'brief');
  this.executeRuleTest(mml, 'a sub 0 más frac 1 sobre a sub 1 más frac 1 sobre a sub 2 más frac 1 sobre puntos suspensivos más frac 1 entre  a sub n', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_7_4_1 = function() {
  ...
  this.executeRuleTest(mml, 'empezar frac 1 entre 2 finalizar frac más empezar frac 2 entre 2 finalizar frac más empezar frac 3 entre 2 finalizar frac más empezar frac 4 entre 2 finalizar frac más puntos suspensivos igual sumatorio bajoíndice n igual 1 sobreíndice infinito finalizar índices empezar frac n entre 2 finalizar frac', 'brief');
  this.executeRuleTest(mml, 'frac 1 entre  2 más frac 2 entre  2 más frac 3 entre  2 más frac 4 entre  2 más puntos suspensivos igual sumatorio bajoíndice n igual 1 sobreíndice infinito finalizar índices frac n entre  2', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_7_4_2 = function() {
  ...
  this.executeRuleTest(mml, 'empezar frac 20 entre 5 finalizar frac por empezar frac 1 entre 100 finalizar frac igual empezar frac 1 entre 25 finalizar frac', 'brief');
  this.executeRuleTest(mml, 'frac 20 entre  5 por frac 1 entre  100 igual frac 1 entre  25', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_7_4_3 = function() {
  ...
  this.executeRuleTest(mml, 'empezar empezar frac empezar frac 3 entre 5 finalizar frac entre entre 8 finalizar finalizar frac igual empezar frac 3 entre 5 finalizar frac por empezar frac 1 entre 8 finalizar frac', 'brief');
  this.executeRuleTest(mml, 'frac frac 3 entre  5 sobre 8 igual frac 3 entre  5 por frac 1 entre  8', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_7_5_1 = function() {
  ...
  this.executeRuleTest(mml, '3 más empezar frac 5 entre 8 finalizar frac igual empezar frac 29 entre 8 finalizar frac', 'brief');
  this.executeRuleTest(mml, '3 más frac 5 entre  8 igual frac 29 entre  8', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_7_6_1 = function() {
  ...
  this.executeRuleTest(mml, 'a sub 0 más frac continua b sub 1 entre a sub 1 más empezar frac b sub 2 entre a sub 2 más empezar frac b sub 3 entre a sub 3 más puntos suspensivos igual a sub 0 más empezar frac b sub 1 entre a sub 1 finalizar frac más empezar frac b sub 2 entre a sub 2 finalizar frac más puntos suspensivos', 'brief');
  this.executeRuleTest(mml, 'a sub 0 más frac continua b sub 1 entre a sub 1 más frac b sub 2 entre a sub 2 más frac b sub 3 entre a sub 3 más puntos suspensivos igual a sub 0 más frac b sub 1 entre  a sub 1 más frac b sub 2 entre  a sub 2 más puntos suspensivos', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_8_1_1 = function() {
  ...
  this.executeRuleTest(mml, 'x al cubo más 6 x al cuadrado menos x igual 30', 'brief');
  this.executeRuleTest(mml, 'x al cubo más 6 x al cuadrado menos x igual 30', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_8_1_2 = function() {
  ...
  this.executeRuleTest(mml, 'empezar frac d al cuadrado y entre d x al cuadrado finalizar frac más paréntesis izquierdo a x al cuadrado más b x más c paréntesis derecho y igual 0', 'brief');
  this.executeRuleTest(mml, 'frac d al cuadrado y entre  d x al cuadrado más paréntesis izquierdo a x al cuadrado más b x más c paréntesis derecho y igual 0', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_8_2_1 = function() {
  ...
  this.executeRuleTest(mml, 'x sup empezar frac 1 entre 2 finalizar frac', 'brief');
...
sre.MathspeakSpanishTest.prototype.testSample_8_3_2 = function() {
  ...
  this.executeRuleTest(mml, 'mayúscula T sub n menos 1 más 5 igual 0', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_8_4_1 = function() {
  ...
  this.executeRuleTest(mml, 'x sup a sup sub n más a sup sub n menos 1', 'brief');
  this.executeRuleTest(mml, 'x sup a sup sub n más a sup sub n menos 1', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_8_4_4 = function() {
  ...
  this.executeRuleTest(mml, 'y sup a sup sup b sup sup sub c no es igual a y sup a sup sup b c', 'brief');
  this.executeRuleTest(mml, 'y sup a sup sup b sup sup sub c no es igual a y sup a sup sup b c', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_8_4_8 = function() {
  ...
  this.executeRuleTest(mml, 'mayúscula T sup paréntesis izquierdo x sup sup a más y sup sup b paréntesis derecho', 'brief');
  this.executeRuleTest(mml, 'mayúscula T sup paréntesis izquierdo x sup sup a más y sup sup b paréntesis derecho', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_8_5_5 = function() {
  ...
  this.executeRuleTest(mml, '4 mayúscula F e más 3 mayúscula O sub 2 flecha derecha 2 mayúscula F e sub 2 mayúscula O sub 3', 'brief');
  this.executeRuleTest(mml, '4 mayúscula F e más 3 mayúscula O sub 2 flecha derecha 2 mayúscula F e sub 2 mayúscula O sub 3', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_8_5_7 = function() {
  ...
  this.executeRuleTest(mml, 'mayúscula T sub n sub sub 1 más n sub sub 0', 'brief');
  this.executeRuleTest(mml, 'mayúscula T sub n sub sub 1 más n sub sub 0', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_8_5_8 = function() {
  ...
  this.executeRuleTest(mml, 'logaritmo sub 2 paréntesis izquierdo x paréntesis derecho igual empezar frac logaritmo sub 10 paréntesis izquierdo x paréntesis derecho entre logaritmo sub 10 paréntesis izquierdo 2 paréntesis derecho finalizar frac', 'brief');
  this.executeRuleTest(mml, 'logaritmo sub 2 paréntesis izquierdo x paréntesis derecho igual frac logaritmo sub 10 paréntesis izquierdo x paréntesis derecho entre  logaritmo sub 10 paréntesis izquierdo 2 paréntesis derecho', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_8_5_10 = function() {
  ...
  this.executeRuleTest(mml, 'logaritmo neperiano x igual integral Sub 1 Sup x Base empezar frac d t entre t finalizar frac', 'brief');
  this.executeRuleTest(mml, 'logaritmo neperiano x igual integral Sub 1 Sup x Base frac d t entre  t', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_8_6_1 = function() {
  ...
  this.executeRuleTest(mml, 'dólar n base 2 igual 2 por dólar n más 1 punto y coma', 'brief');
  this.executeRuleTest(mml, 'dólar n base 2 igual 2 por dólar n más 1 punto y coma', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSampleTensorMultiSubSup = function() {
  ...
  this.executeRuleTest(mml, 'sub a sup b x sub c sub sub l sub sub sup k e sup d', 'brief');
  this.executeRuleTest(mml, 'sub a sup b x sub c sub sub l sub sub sup k e sup d', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSampleTwoTensors = function() {
  ...
  this.executeRuleTest(mml, 'sub a sup b x sub c sup d sub a sup b x sub c sup d', 'brief');
  this.executeRuleTest(mml, 'sub a sup b x sub c sup d sub a sup b x sub c sup d', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSamplePartialTensorABCDRoot = function() {
  ...
  this.executeRuleTest(mml, 'empezar raíz cuadrada sub a sup b x sub c sup d finalizar raíz cuadrada', 'brief');
  this.executeRuleTest(mml, 'raíz cuadrada sub a sup b x sub c sup d finalizar raíz cuadrada', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSamplePartialTensorABCDRootR = function() {
  ...
  this.executeRuleTest(mml, 'empezar raíz cuadrada sub a sup b x sub c sup d finalizar raíz cuadrada r', 'brief');
  this.executeRuleTest(mml, 'raíz cuadrada sub a sup b x sub c sup d finalizar raíz cuadrada r', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSamplePartialTensorABCDFrac = function() {
  ...
  this.executeRuleTest(mml, 'empezar frac 1 entre sub a sup b x sub c sup d finalizar frac', 'brief');
  this.executeRuleTest(mml, 'frac 1 entre  sub a sup b x sub c sup d', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSamplePartialTensorABCDFracR = function() {
  ...
  this.executeRuleTest(mml, 'empezar frac 1 entre sub a sup b x sub c sup d finalizar frac r', 'brief');
  this.executeRuleTest(mml, 'frac 1 entre  sub a sup b x sub c sup d r', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_8_9_2 = function() {
  ...
  this.executeRuleTest(mml, 'f triple prima paréntesis izquierdo y paréntesis derecho igual empezar frac d f doble prima paréntesis izquierdo y paréntesis derecho entre d y finalizar frac', 'brief');
  this.executeRuleTest(mml, 'f triple prima paréntesis izquierdo y paréntesis derecho igual frac d f doble prima paréntesis izquierdo y paréntesis derecho entre  d y', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_8_10_1 = function() {
  ...
  this.executeRuleTest(mml, 'rho prima igual rho prima sub más más rho prima sub menos', 'brief');
  this.executeRuleTest(mml, 'rho prima igual rho prima sub más más rho prima sub menos', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_8_11_1 = function() {
  ...
  this.executeRuleTest(mml, 'empezar matriz 2 por 3 primera fila primera columna x sup n segunda columna y sup n tercera columna z sup n segunda fila primera columna x sup n más 1 segunda columna y sup n más 1 tercera columna z sup n más 1 finalizar matriz', 'brief');
  this.executeRuleTest(mml, 'matriz 2 por 3 primera  primera columna x sup n segunda columna y sup n tercera columna z sup n segunda  primera columna x sup n más 1 segunda columna y sup n más 1 tercera columna z sup n más 1 finalizar matriz', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_9_1_1 = function() {
  ...
  this.executeRuleTest(mml, 'empezar raíz cuadrada 2 finalizar raíz cuadrada', 'brief');
  this.executeRuleTest(mml, 'raíz cuadrada 2 finalizar raíz cuadrada', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_9_1_2 = function() {
  ...
  this.executeRuleTest(mml, 'empezar raíz cuadrada m más n finalizar raíz cuadrada', 'brief');
  this.executeRuleTest(mml, 'raíz cuadrada m más n finalizar raíz cuadrada', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_9_2_1 = function() {
  ...
  this.executeRuleTest(mml, 'índice de raíz m más n empezar raíz x más y finalizar raíz', 'brief');
...
sre.MathspeakSpanishTest.prototype.testSample_9_2_2 = function() {
  ...
  this.executeRuleTest(mml, 'índice de raíz n empezar raíz x sup m finalizar raíz igual paréntesis izquierdo índice de raíz n empezar raíz x finalizar raíz paréntesis derecho sup m igual x sup empezar frac m entre n finalizar frac coma x mayor que 0', 'brief');
  this.executeRuleTest(mml, 'n raíz x sup m finalizar raíz igual paréntesis izquierdo n raíz x finalizar raíz paréntesis derecho sup m igual x sup frac m entre  n coma x mayor que 0', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_9_2_3 = function() {
  ...
  this.executeRuleTest(mml, 'empezar raíz cúbica x finalizar raíz cúbica igual x sup empezar frac 1 entre 3 finalizar frac', 'brief');
  this.executeRuleTest(mml, 'raíz cúbica x finalizar raíz cúbica igual x sup frac 1 entre  3', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_9_3_1 = function() {
  ...
  this.executeRuleTest(mml, 'empezar raíz cuadrada empezar raíz cuadrada x más 1 finalizar raíz cuadrada más empezar raíz cuadrada y más 1 finalizar raíz cuadrada finalizar raíz cuadrada', 'brief');
  this.executeRuleTest(mml, 'raíz cuadrada raíz cuadrada x más 1 finalizar raíz cuadrada más raíz cuadrada y más 1 finalizar raíz cuadrada finalizar raíz cuadrada', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_9_3_2 = function() {
  ...
  this.executeRuleTest(mml, 'índice de raíz n empezar raíz índice de raíz m empezar raíz x finalizar raíz finalizar raíz igual índice de raíz m empezar raíz índice de raíz n empezar raíz x finalizar raíz finalizar raíz', 'brief');
  this.executeRuleTest(mml, 'n raíz m raíz x finalizar raíz finalizar raíz igual m raíz n raíz x finalizar raíz finalizar raíz', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_9_3_3 = function() {
  ...
  this.executeRuleTest(mml, 'x sup e menos 2 igual empezar raíz cuadrada x empezar raíz cúbica x empezar raíz a la cuarta x empezar raíz a la quinta x puntos suspensivos finalizar raíz a la quinta finalizar raíz a la cuarta finalizar raíz cúbica finalizar raíz cuadrada coma x perteneciente a negrita de pizarra mayúscula R', 'brief');
  this.executeRuleTest(mml, 'x sup e menos 2 igual raíz cuadrada x raíz cúbica x raíz a la cuarta x raíz a la quinta x puntos suspensivos finalizar raíz a la quinta finalizar raíz a la cuarta finalizar raíz cúbica finalizar raíz cuadrada coma x perteneciente a negrita de pizarra mayúscula R', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_9_3_4 = function() {
  ...
  this.executeRuleTest(mml, 'empezar frac 2 entre pi finalizar frac igual empezar frac empezar raíz cuadrada 2 finalizar raíz cuadrada entre 2 finalizar frac empezar frac empezar raíz cuadrada 2 más empezar raíz cuadrada 2 finalizar raíz cuadrada finalizar raíz cuadrada entre 2 finalizar frac empezar frac empezar raíz cuadrada 2 más empezar raíz cuadrada 2 más empezar raíz cuadrada 2 finalizar raíz cuadrada finalizar raíz cuadrada finalizar raíz cuadrada entre 2 finalizar frac puntos suspensivos', 'brief');
  this.executeRuleTest(mml, 'frac 2 entre  pi igual frac raíz cuadrada 2 finalizar raíz cuadrada entre  2 frac raíz cuadrada 2 más raíz cuadrada 2 finalizar raíz cuadrada finalizar raíz cuadrada entre  2 frac raíz cuadrada 2 más raíz cuadrada 2 más raíz cuadrada 2 finalizar raíz cuadrada finalizar raíz cuadrada finalizar raíz cuadrada entre  2 puntos suspensivos', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_10_1_1 = function() {
  ...
  this.executeRuleTest(mml, 'empezar frac 5 x tachado y finalizar tachado entre 2 tachado y finalizar tachado finalizar frac igual empezar frac 5 entre 2 finalizar frac x', 'brief');
  this.executeRuleTest(mml, 'frac 5 x tachado y finalizar tachado entre  2 tachado y finalizar tachado igual frac 5 entre  2 x', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_10_2_1 = function() {
  ...
  this.executeRuleTest(mml, 'empezar frac 12 entre 18 finalizar frac igual empezar frac tachado 12 con 2 finalizar tachado entre tachado 18 con 3 finalizar tachado finalizar frac igual empezar frac 2 entre 3 finalizar frac', 'brief');
  this.executeRuleTest(mml, 'frac 12 entre  18 igual frac tachado 12 con 2 finalizar tachado entre  tachado 18 con 3 finalizar tachado igual frac 2 entre  3', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_11_1_2 = function() {
  ...
  this.executeRuleTest(mml, 'mod superior x más y con flecha derecha', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_11_2_1 = function() {
  ...
  this.executeRuleTest(mml, 'mod inferior x con punto en superescrito', 'brief');
  this.executeRuleTest(mml, 'mod inferior x con punto en superescrito', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_11_6_1 = function() {
  ...
  this.executeRuleTest(mml, 'mod inferior inferior mod inferior a más b con subrayado con por', 'brief');
  this.executeRuleTest(mml, 'mod inferior inferior mod inferior a más b con subrayado con por', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_11_6_3 = function() {
  ...
  this.executeRuleTest(mml, 'mod superior superior mod superior x más y con tilde con barra', 'brief');
  this.executeRuleTest(mml, 'mod superior superior mod superior x más y con tilde con barra', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_11_7_1 = function() {
  ...
  this.executeRuleTest(mml, 'sumatorio bajoíndice n igual 1 sobreíndice infinito finalizar índices a sub n', 'brief');
  this.executeRuleTest(mml, 'sumatorio bajoíndice n igual 1 sobreíndice infinito finalizar índices a sub n', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_11_8_1 = function() {
  ...
  this.executeRuleTest(mml, 'modificando inferior x más y con subrayado bajoíndice a igual 5 bajobajoíndice b igual 3 finalizar índices', 'default');
  this.executeRuleTest(mml, 'mod inferior x más y con subrayado bajoíndice a igual 5 bajobajoíndice b igual 3 finalizar índices', 'brief');
  this.executeRuleTest(mml, 'mod inferior x más y con subrayado bajoíndice a igual 5 bajobajoíndice b igual 3 finalizar índices', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_11_8_2 = function() {
  ...
  this.executeRuleTest(mml, 'modificando superior x más y con barra sobreíndice n igual 1 sobresobreíndice m igual 2 finalizar índices', 'default');
  this.executeRuleTest(mml, 'mod superior x más y con barra sobreíndice n igual 1 sobresobreíndice m igual 2 finalizar índices', 'brief');
  this.executeRuleTest(mml, 'mod superior x más y con barra sobreíndice n igual 1 sobresobreíndice m igual 2 finalizar índices', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_13_1_1 = function() {
  ...
  this.executeRuleTest(mml, 'empezar frac 60 tachado millas finalizar tachado entre tachado horas finalizar tachado finalizar frac por empezar frac 5280 pies entre 1 tachado millas finalizar tachado finalizar frac por empezar frac 1 tachado horas finalizar tachado entre 60 minutos finalizar frac igual empezar frac 5280 pies entre minutos finalizar frac', 'brief');
  this.executeRuleTest(mml, 'frac 60 tachado millas finalizar tachado entre  tachado horas finalizar tachado por frac 5280 pies entre  1 tachado millas finalizar tachado por frac 1 tachado horas finalizar tachado entre  60 minutos igual frac 5280 pies entre  minutos', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_13_1_2 = function() {
  ...
  this.executeRuleTest(mml, '1 Joules igual 1 kilogramo por metro al cuadrado por segundos sup menos 2', 'brief');
  this.executeRuleTest(mml, '1 Joules igual 1 kilogramo por metro al cuadrado por segundos sup menos 2', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_13_1_3 = function() {
  ...
  this.executeRuleTest(mml, 'm metros igual 100 m centímetros igual empezar frac m entre 1000 finalizar frac kilómetros', 'brief');
  this.executeRuleTest(mml, 'm metros igual 100 m centímetros igual frac m entre  1000 kilómetros', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_14_1_1 = function() {
  ...
  this.executeRuleTest(mml, 'empezar esquema primera fila primera columna mayúscula H sub 2 segunda columna más tercera columna mayúscula F sub 2 cuarta columna flecha derecha quinta columna 2 mayúscula H mayúscula F segunda fila primera columna hydrogen segunda columna espacio tercera columna fluorine cuarta columna espacio quinta columna hydrogen fluoride finalizar esquema', 'brief');
  this.executeRuleTest(mml, 'esquema primera fila primera columna mayúscula H sub 2 segunda columna más tercera columna mayúscula F sub 2 cuarta columna flecha derecha quinta columna 2 mayúscula H mayúscula F segunda fila primera columna hydrogen segunda columna espacio tercera columna fluorine cuarta columna espacio quinta columna hydrogen fluoride finalizar esquema', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_14_3_1 = function() {
  ...
  this.executeRuleTest(mml, 'x igual empezar esquema llave izquierda alargada primera fila primera columna y menor que 0 segunda columna 0 segunda fila primera columna y mayor o igual que 0 segunda columna 2 y finalizar esquema', 'brief');
  this.executeRuleTest(mml, 'x igual esquema llave izquierda alargada primera fila primera columna y menor que 0 segunda columna 0 segunda fila primera columna y mayor o igual que 0 segunda columna 2 y finalizar esquema', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_15_1_1 = function() {
  ...
  this.executeRuleTest(mml, 'empezar matriz 3 por 3 primera fila primera columna x más a segunda columna x más b tercera columna x más c segunda fila primera columna y más a segunda columna y más b tercera columna y más c tercera fila primera columna z más a segunda columna z más b tercera columna z más c finalizar matriz', 'brief');
  this.executeRuleTest(mml, 'matriz 3 por 3 primera  primera columna x más a segunda columna x más b tercera columna x más c segunda  primera columna y más a segunda columna y más b tercera columna y más c tercera  primera columna z más a segunda columna z más b tercera columna z más c finalizar matriz', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_15_2_1 = function() {
  ...
  this.executeRuleTest(mml, 'empezar determinante 2 por 2 primera fila primera columna a más 1 segunda columna b segunda fila primera columna c segunda columna d finalizar determinante igual paréntesis izquierdo a más 1 paréntesis derecho d menos b c', 'brief');
  this.executeRuleTest(mml, 'determinante 2 por 2 primera fila primera columna a más 1 segunda columna b segunda fila primera columna c segunda columna d finalizar determinante igual paréntesis izquierdo a más 1 paréntesis derecho d menos b c', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_15_4_1 = function() {
  ...
  this.executeRuleTest(mml, 'empezar determinante 2 por 2 primera fila a b segunda fila c d finalizar determinante igual a d menos b c', 'brief');
  this.executeRuleTest(mml, 'determinante 2 por 2 primera fila a b segunda fila c d finalizar determinante igual a d menos b c', 'sbrief');
};
...
sre.MathspeakSpanishTest.prototype.testSample_15_6_1 = function() {
  ...
  this.executeRuleTest(mml, 'empezar binomial x en y finalizar binomial', 'brief');
