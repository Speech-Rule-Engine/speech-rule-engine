...
goog.provide('sre.MathspeakGermanFontTest');
 ...
 */
sre.MathspeakGermanFontTest = function() {
  sre.MathspeakGermanFontTest.base(this, 'constructor');

  /**
   * @override
   */
  this.information = 'Mathspeak German Font tests.';
 ...
 */
sre.MathspeakGermanFontTest.prototype.testLatinMathfontsUpper = function() {
  this.executeRuleTest('<mi>&#x0041;</mi>', 'großes A', 'default');
  this.executeRuleTest('<mi>&#xFF21;</mi>', 'großes A', 'default');
  this.executeRuleTest('<mi>&#x1D400;</mi>', 'fettes großes A', 'default');
  this.executeRuleTest('<mi>&#x1D434;</mi>', 'großes A', 'default');
  this.executeRuleTest('<mi>&#x1D468;</mi>', 'fettkursives großes A', 'default');
  this.executeRuleTest('<mi>&#x1D49C;</mi>', 'Schreibschrift großes A', 'default');
  this.executeRuleTest('<mi>&#x1D4D0;</mi>', 'fettes Schreibschrift großes A', 'default');
  this.executeRuleTest('<mi>&#x1D504;</mi>', 'Fraktur großes A', 'default');
  this.executeRuleTest('<mi>&#x1D538;</mi>', 'großes A mit Doppelstrich', 'default');
  this.executeRuleTest('<mi>&#x1D56C;</mi>', 'fettes Fraktur großes A', 'default');
  this.executeRuleTest('<mi>&#x1D5A0;</mi>', 'serifenloses großes A', 'default');
  this.executeRuleTest('<mi>&#x1D5D4;</mi>', 'serifenloses fettes großes A', 'default');
  this.executeRuleTest('<mi>&#x1D608;</mi>', 'serifenloses kursives großes A', 'default');
  this.executeRuleTest('<mi>&#x1D63C;</mi>', 'serifenloses fettkursives großes A', 'default');
  this.executeRuleTest('<mi>&#x1D670;</mi>', 'nichtproportionales großes A', 'default');
};
 ...
 */
sre.MathspeakGermanFontTest.prototype.testGreekMathfontsUpper = function() {
  this.executeRuleTest('<mi>&#x0391;</mi>', 'großes Alpha', 'default');
  this.executeRuleTest('<mi>&#x1D6A8;</mi>', 'fettes großes Alpha', 'default');
  this.executeRuleTest('<mi>&#x1D6E2;</mi>', 'großes Alpha', 'default');
  this.executeRuleTest('<mi>&#x1D71C;</mi>', 'fettkursives großes Alpha', 'default');
  this.executeRuleTest('<mi>&#x1D756;</mi>', 'serifenloses fettes großes Alpha', 'default');
  this.executeRuleTest('<mi>&#x1D790;</mi>', 'serifenloses fettkursives großes Alpha', 'default');
};
 ...
 */
sre.MathspeakGermanFontTest.prototype.testLatinMathfontsSmall = function() {
 ...
 */
sre.MathspeakGermanFontTest.prototype.testGreekMathfontsSmall = function() {
 ...
 */
sre.MathspeakGermanFontTest.prototype.testLatinMathvariantUpper = function() {
  this.executeRuleTest('<mi mathvariant="normal">A</mi>', 'normales großes A', 'default');
  this.executeRuleTest('<mi mathvariant="bold">A</mi>', 'fettes großes A', 'default');
  this.executeRuleTest('<mi mathvariant="italic">A</mi>', 'großes A', 'default');
  this.executeRuleTest('<mi mathvariant="bold-italic">A</mi>', 'fettkursives großes A', 'default');
  this.executeRuleTest('<mi mathvariant="script">A</mi>', 'Schreibschrift großes A', 'default');
  this.executeRuleTest('<mi mathvariant="bold-script">A</mi>', 'fettes Schreibschrift großes A', 'default');
  this.executeRuleTest('<mi mathvariant="fraktur">A</mi>', 'Fraktur großes A', 'default');
  this.executeRuleTest('<mi mathvariant="double-struck">A</mi>', 'großes A mit Doppelstrich', 'default');
  this.executeRuleTest('<mi mathvariant="bold-fraktur">A</mi>', 'fettes Fraktur großes A', 'default');
  this.executeRuleTest('<mi mathvariant="sans-serif">A</mi>', 'serifenloses großes A', 'default');
  this.executeRuleTest('<mi mathvariant="sans-serif-bold">A</mi>', 'serifenloses fettes großes A', 'default');
  this.executeRuleTest('<mi mathvariant="sans-serif-italic">A</mi>', 'serifenloses kursives großes A', 'default');
  this.executeRuleTest('<mi mathvariant="sans-serif-bold-italic">A</mi>', 'serifenloses fettkursives großes A', 'default');
  this.executeRuleTest('<mi mathvariant="monospace">A</mi>', 'nichtproportionales großes A', 'default');
};
 ...
 */
sre.MathspeakGermanFontTest.prototype.testLatinMathvariantMathJax = function() {
  this.executeRuleTest('<mi mathvariant="-tex-caligraphic">A</mi>', 'kalligrafisches großes A', 'default');
  this.executeRuleTest('<mi mathvariant="-tex-caligraphic-bold">A</mi>', 'fettes kalligrafisches großes A', 'default');
  this.executeRuleTest('<mi mathvariant="-tex-calligraphic">A</mi>', 'kalligrafisches großes A', 'default');
  this.executeRuleTest('<mi mathvariant="-tex-calligraphic-bold">A</mi>', 'fettes kalligrafisches großes A', 'default');
  this.executeRuleTest('<mi mathvariant="-tex-mathit">A</mi>', 'großes A', 'default');
};
 ...
 */
sre.MathspeakGermanFontTest.prototype.testGreekMathvariantUpper = function() {
  this.executeRuleTest('<mi mathvariant="normal">&#x0391;</mi>', 'normales großes Alpha', 'default');
  this.executeRuleTest('<mi mathvariant="bold">&#x0391;</mi>', 'fettes großes Alpha', 'default');
  this.executeRuleTest('<mi mathvariant="italic">&#x0391;</mi>', 'großes Alpha', 'default');
  this.executeRuleTest('<mi mathvariant="bold-italic">&#x0391;</mi>', 'fettkursives großes Alpha', 'default');
  this.executeRuleTest('<mi mathvariant="sans-serif-bold">&#x0391;</mi>', 'serifenloses fettes großes Alpha', 'default');
  this.executeRuleTest('<mi mathvariant="sans-serif-bold-italic">&#x0391;</mi>', 'serifenloses fettkursives großes Alpha', 'default');
};
 ...
 */
sre.MathspeakGermanFontTest.prototype.testLatinMathvariantSmall = function() {
 ...
 */
sre.MathspeakGermanFontTest.prototype.testGreekMathvariantSmall = function() {
 ...
 */
sre.MathspeakGermanFontTest.prototype.testLatinFontVariantsUpper = function() {
  this.executeRuleTest('<mi mathvariant="normal">&#x0041;</mi>', 'normales großes A', 'default');
  this.executeRuleTest('<mi mathvariant="normal">&#xFF21;</mi>', 'normales großes A', 'default');
  this.executeRuleTest('<mi mathvariant="bold">&#x1D400;</mi>', 'fettes großes A', 'default');
  this.executeRuleTest('<mi mathvariant="italic">&#x1D434;</mi>', 'großes A', 'default');
  this.executeRuleTest('<mi mathvariant="bold-italic">&#x1D468;</mi>', 'fettkursives großes A', 'default');
  this.executeRuleTest('<mi mathvariant="script">&#x1D49C;</mi>', 'Schreibschrift großes A', 'default');
  this.executeRuleTest('<mi mathvariant="bold-script">&#x1D4D0;</mi>', 'fettes Schreibschrift großes A', 'default');
  this.executeRuleTest('<mi mathvariant="fraktur">&#x1D504;</mi>', 'Fraktur großes A', 'default');
  this.executeRuleTest('<mi mathvariant="double-struck">&#x1D538;</mi>', 'großes A mit Doppelstrich', 'default');
  this.executeRuleTest('<mi mathvariant="bold-fraktur">&#x1D56C;</mi>', 'fettes Fraktur großes A', 'default');
  this.executeRuleTest('<mi mathvariant="sans-serif">&#x1D5A0;</mi>', 'serifenloses großes A', 'default');
  this.executeRuleTest('<mi mathvariant="sans-serif-bold">&#x1D5D4;</mi>', 'serifenloses fettes großes A', 'default');
  this.executeRuleTest('<mi mathvariant="sans-serif-italic">&#x1D608;</mi>', 'serifenloses kursives großes A', 'default');
  this.executeRuleTest('<mi mathvariant="sans-serif-bold-italic">&#x1D63C;</mi>', 'serifenloses fettkursives großes A', 'default');
  this.executeRuleTest('<mi mathvariant="monospace">&#x1D670;</mi>', 'nichtproportionales großes A', 'default');
};
 ...
 */
sre.MathspeakGermanFontTest.prototype.testGreekFontVariantsUpper = function() {
  this.executeRuleTest('<mi mathvariant="normal">&#x0391;</mi>', 'normales großes Alpha', 'default');
  this.executeRuleTest('<mi mathvariant="bold">&#x1D6A8;</mi>', 'fettes großes Alpha', 'default');
  this.executeRuleTest('<mi mathvariant="italic">&#x1D6E2;</mi>', 'großes Alpha', 'default');
  this.executeRuleTest('<mi mathvariant="bold-italic">&#x1D71C;</mi>', 'fettkursives großes Alpha', 'default');
  this.executeRuleTest('<mi mathvariant="sans-serif-bold">&#x1D756;</mi>', 'serifenloses fettes großes Alpha', 'default');
  this.executeRuleTest('<mi mathvariant="sans-serif-bold-italic">&#x1D790;</mi>', 'serifenloses fettkursives großes Alpha', 'default');
};
 ...
 */
sre.MathspeakGermanFontTest.prototype.testLatinFontVariantsSmall = function() {
  this.executeRuleTest('<mi mathvariant="normal">&#x0061;</mi>', 'normales a', 'default');
 ...
 */
sre.MathspeakGermanFontTest.prototype.testGreekFontVariantsSmall = function() {
  this.executeRuleTest('<mi mathvariant="normal">&#x03B1;</mi>', 'normales alpha', 'default');
 ...
 */
sre.MathspeakGermanFontTest.prototype.testDigitsMathfonts = function() {
 ...
 */
sre.MathspeakGermanFontTest.prototype.testDigitsMathvariant = function() {
 ...
 */
sre.MathspeakGermanFontTest.prototype.testDigitsFontVariants = function() {
  this.executeRuleTest('<mn mathvariant="normal">&#x0030;</mn>', '0', 'default');
