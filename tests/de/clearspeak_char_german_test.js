...
goog.provide('sre.ClearspeakCharGermanTest');
 ...
 */
sre.ClearspeakCharGermanTest = function() {
  sre.ClearspeakCharGermanTest.base(this, 'constructor');
...
sre.ClearspeakCharGermanTest.prototype.testClearspeakChars = function() {
  ...
  this.executeCharTest('⁰', ['hoch 0']);
  this.executeCharTest('¹', ['hoch 1']);
  this.executeCharTest('²', ['hoch 2']);
  this.executeCharTest('³', ['hoch 3']);
  this.executeCharTest('⁴', ['hoch 4']);
  this.executeCharTest('⁵', ['hoch 5']);
  this.executeCharTest('⁶', ['hoch 6']);
  this.executeCharTest('⁷', ['hoch 7']);
  this.executeCharTest('⁸', ['hoch 8']);
  this.executeCharTest('⁹', ['hoch 9']);
  this.executeCharTest('₀', ['Index 0']);
  this.executeCharTest('₁', ['Index 1']);
  this.executeCharTest('₂', ['Index 2']);
  this.executeCharTest('₃', ['Index 3']);
  this.executeCharTest('₄', ['Index 4']);
  this.executeCharTest('₅', ['Index 5']);
  this.executeCharTest('₆', ['Index 6']);
  this.executeCharTest('₇', ['Index 7']);
  this.executeCharTest('₈', ['Index 8']);
  this.executeCharTest('₉', ['Index 9']);
  this.executeCharTest('⓪', ['eingekreiste 0']);
  this.executeCharTest('①', ['eingekreiste 1']);
  this.executeCharTest('②', ['eingekreiste 2']);
  this.executeCharTest('③', ['eingekreiste 3']);
  this.executeCharTest('④', ['eingekreiste 4']);
  this.executeCharTest('⑤', ['eingekreiste 5']);
  this.executeCharTest('⑥', ['eingekreiste 6']);
  this.executeCharTest('⑦', ['eingekreiste 7']);
  this.executeCharTest('⑧', ['eingekreiste 8']);
  this.executeCharTest('⑨', ['eingekreiste 9']);
  this.executeCharTest('⑩', ['eingekreiste 10']);
  this.executeCharTest('⑪', ['eingekreiste 11']);
  this.executeCharTest('⑫', ['eingekreiste 12']);
  this.executeCharTest('⑬', ['eingekreiste 13']);
  this.executeCharTest('⑭', ['eingekreiste 14']);
  this.executeCharTest('⑮', ['eingekreiste 15']);
  this.executeCharTest('⑯', ['eingekreiste 16']);
  this.executeCharTest('⑰', ['eingekreiste 17']);
  this.executeCharTest('⑱', ['eingekreiste 18']);
  this.executeCharTest('⑲', ['eingekreiste 19']);
  this.executeCharTest('⑳', ['eingekreiste 20']);
  this.executeCharTest('㉑', ['eingekreiste 21']);
  this.executeCharTest('㉒', ['eingekreiste 22']);
  this.executeCharTest('㉓', ['eingekreiste 23']);
  this.executeCharTest('㉔', ['eingekreiste 24']);
  this.executeCharTest('㉕', ['eingekreiste 25']);
  this.executeCharTest('㉖', ['eingekreiste 26']);
  this.executeCharTest('㉗', ['eingekreiste 27']);
  this.executeCharTest('㉘', ['eingekreiste 28']);
  this.executeCharTest('㉙', ['eingekreiste 29']);
  this.executeCharTest('㉚', ['eingekreiste 30']);
  this.executeCharTest('㉛', ['eingekreiste 31']);
  this.executeCharTest('㉜', ['eingekreiste 32']);
  this.executeCharTest('㉝', ['eingekreiste 33']);
  this.executeCharTest('㉞', ['eingekreiste 34']);
  this.executeCharTest('㉟', ['eingekreiste 35']);
  this.executeCharTest('㊱', ['eingekreiste 36']);
  this.executeCharTest('㊲', ['eingekreiste 37']);
  this.executeCharTest('㊳', ['eingekreiste 38']);
  this.executeCharTest('㊴', ['eingekreiste 39']);
  this.executeCharTest('㊵', ['eingekreiste 40']);
  this.executeCharTest('㊶', ['eingekreiste 41']);
  this.executeCharTest('㊷', ['eingekreiste 42']);
  this.executeCharTest('㊸', ['eingekreiste 43']);
  this.executeCharTest('㊹', ['eingekreiste 44']);
  this.executeCharTest('㊺', ['eingekreiste 45']);
  this.executeCharTest('㊻', ['eingekreiste 46']);
  this.executeCharTest('㊼', ['eingekreiste 47']);
  this.executeCharTest('㊽', ['eingekreiste 48']);
  this.executeCharTest('㊾', ['eingekreiste 49']);
  this.executeCharTest('㊿', ['eingekreiste 50']);
  this.executeCharTest('⑴', ['eingeklammerte 1']);
  this.executeCharTest('⑵', ['eingeklammerte 2']);
  this.executeCharTest('⑶', ['eingeklammerte 3']);
  this.executeCharTest('⑷', ['eingeklammerte 4']);
  this.executeCharTest('⑸', ['eingeklammerte 5']);
  this.executeCharTest('⑹', ['eingeklammerte 6']);
  this.executeCharTest('⑺', ['eingeklammerte 7']);
  this.executeCharTest('⑻', ['eingeklammerte 8']);
  this.executeCharTest('⑼', ['eingeklammerte 9']);
  this.executeCharTest('⑽', ['eingeklammerte 10']);
  this.executeCharTest('⑾', ['eingeklammerte 11']);
  this.executeCharTest('⑿', ['eingeklammerte 12']);
  this.executeCharTest('⒀', ['eingeklammerte 13']);
  this.executeCharTest('⒁', ['eingeklammerte 14']);
  this.executeCharTest('⒂', ['eingeklammerte 15']);
  this.executeCharTest('⒃', ['eingeklammerte 16']);
  this.executeCharTest('⒄', ['eingeklammerte 17']);
  this.executeCharTest('⒅', ['eingeklammerte 18']);
  this.executeCharTest('⒆', ['eingeklammerte 19']);
  this.executeCharTest('⒇', ['eingeklammerte 20']);
  this.executeCharTest('🄀', ['0 Punkt']);
  this.executeCharTest('⒈', ['1 Punkt']);
  this.executeCharTest('⒉', ['2 Punkt']);
  this.executeCharTest('⒊', ['3 Punkt']);
  this.executeCharTest('⒋', ['4 Punkt']);
  this.executeCharTest('⒌', ['5 Punkt']);
  this.executeCharTest('⒍', ['6 Punkt']);
  this.executeCharTest('⒎', ['7 Punkt']);
  this.executeCharTest('⒏', ['8 Punkt']);
  this.executeCharTest('⒐', ['9 Punkt']);
  this.executeCharTest('⒑', ['10 Punkt']);
  this.executeCharTest('⒒', ['11 Punkt']);
  this.executeCharTest('⒓', ['12 Punkt']);
  this.executeCharTest('⒔', ['13 Punkt']);
  this.executeCharTest('⒕', ['14 Punkt']);
  this.executeCharTest('⒖', ['15 Punkt']);
  this.executeCharTest('⒗', ['16 Punkt']);
  this.executeCharTest('⒘', ['17 Punkt']);
  this.executeCharTest('⒙', ['18 Punkt']);
  this.executeCharTest('⒚', ['19 Punkt']);
  this.executeCharTest('⒛', ['20 Punkt']);
  this.executeCharTest('⓿', ['schwarz eingekreiste 0']);
  this.executeCharTest('❶', ['schwarz eingekreiste 1']);
  this.executeCharTest('❷', ['schwarz eingekreiste 2']);
  this.executeCharTest('❸', ['schwarz eingekreiste 3']);
  this.executeCharTest('❹', ['schwarz eingekreiste 4']);
  this.executeCharTest('❺', ['schwarz eingekreiste 5']);
  this.executeCharTest('❻', ['schwarz eingekreiste 6']);
  this.executeCharTest('❼', ['schwarz eingekreiste 7']);
  this.executeCharTest('❽', ['schwarz eingekreiste 8']);
  this.executeCharTest('❾', ['schwarz eingekreiste 9']);
  this.executeCharTest('❿', ['schwarz eingekreiste 10']);
  this.executeCharTest('⓫', ['schwarz eingekreiste 11']);
  this.executeCharTest('⓬', ['schwarz eingekreiste 12']);
  this.executeCharTest('⓭', ['schwarz eingekreiste 13']);
  this.executeCharTest('⓮', ['schwarz eingekreiste 14']);
  this.executeCharTest('⓯', ['schwarz eingekreiste 15']);
  this.executeCharTest('⓰', ['schwarz eingekreiste 16']);
  this.executeCharTest('⓱', ['schwarz eingekreiste 17']);
  this.executeCharTest('⓲', ['schwarz eingekreiste 18']);
  this.executeCharTest('⓳', ['schwarz eingekreiste 19']);
  this.executeCharTest('⓴', ['schwarz eingekreiste 20']);
  this.executeCharTest('⓵', ['doppelt eingekreiste 1']);
  this.executeCharTest('⓶', ['doppelt eingekreiste 2']);
  this.executeCharTest('⓷', ['doppelt eingekreiste 3']);
  this.executeCharTest('⓸', ['doppelt eingekreiste 4']);
  this.executeCharTest('⓹', ['doppelt eingekreiste 5']);
  this.executeCharTest('⓺', ['doppelt eingekreiste 6']);
  this.executeCharTest('⓻', ['doppelt eingekreiste 7']);
  this.executeCharTest('⓼', ['doppelt eingekreiste 8']);
  this.executeCharTest('⓽', ['doppelt eingekreiste 9']);
  this.executeCharTest('⓾', ['doppelt eingekreiste 10']);
  this.executeCharTest('🄋', ['eingekreiste serifenlose 0']);
  this.executeCharTest('➀', ['eingekreiste serifenlose 1']);
  this.executeCharTest('➁', ['eingekreiste serifenlose 2']);
  this.executeCharTest('➂', ['eingekreiste serifenlose 3']);
  this.executeCharTest('➃', ['eingekreiste serifenlose 4']);
  this.executeCharTest('➄', ['eingekreiste serifenlose 5']);
  this.executeCharTest('➅', ['eingekreiste serifenlose 6']);
  this.executeCharTest('➆', ['eingekreiste serifenlose 7']);
  this.executeCharTest('➇', ['eingekreiste serifenlose 8']);
  this.executeCharTest('➈', ['eingekreiste serifenlose 9']);
  this.executeCharTest('➉', ['eingekreiste serifenlose 10']);
  this.executeCharTest('🄌', ['schwarz eingekreiste serifenlose 0']);
  this.executeCharTest('➊', ['schwarz eingekreiste serifenlose 1']);
  this.executeCharTest('➋', ['schwarz eingekreiste serifenlose 2']);
  this.executeCharTest('➌', ['schwarz eingekreiste serifenlose 3']);
  this.executeCharTest('➍', ['schwarz eingekreiste serifenlose 4']);
  this.executeCharTest('➎', ['schwarz eingekreiste serifenlose 5']);
  this.executeCharTest('➏', ['schwarz eingekreiste serifenlose 6']);
  this.executeCharTest('➐', ['schwarz eingekreiste serifenlose 7']);
  this.executeCharTest('➑', ['schwarz eingekreiste serifenlose 8']);
  this.executeCharTest('➒', ['schwarz eingekreiste serifenlose 9']);
  this.executeCharTest('➓', ['schwarz eingekreiste serifenlose 10']);
  ...
  this.executeCharTest('𝟎', ['fette 0']);
  this.executeCharTest('𝟏', ['fette 1']);
  this.executeCharTest('𝟐', ['fette 2']);
  this.executeCharTest('𝟑', ['fette 3']);
  this.executeCharTest('𝟒', ['fette 4']);
  this.executeCharTest('𝟓', ['fette 5']);
  this.executeCharTest('𝟔', ['fette 6']);
  this.executeCharTest('𝟕', ['fette 7']);
  this.executeCharTest('𝟖', ['fette 8']);
  this.executeCharTest('𝟗', ['fette 9']);
  this.executeCharTest('𝟘', ['0 mit Doppelstrich']);
  this.executeCharTest('𝟙', ['1 mit Doppelstrich']);
  this.executeCharTest('𝟚', ['2 mit Doppelstrich']);
  this.executeCharTest('𝟛', ['3 mit Doppelstrich']);
  this.executeCharTest('𝟜', ['4 mit Doppelstrich']);
  this.executeCharTest('𝟝', ['5 mit Doppelstrich']);
  this.executeCharTest('𝟞', ['6 mit Doppelstrich']);
  this.executeCharTest('𝟟', ['7 mit Doppelstrich']);
  this.executeCharTest('𝟠', ['8 mit Doppelstrich']);
  this.executeCharTest('𝟡', ['9 mit Doppelstrich']);
  this.executeCharTest('𝟢', ['serifenlose 0']);
  this.executeCharTest('𝟣', ['serifenlose 1']);
  this.executeCharTest('𝟤', ['serifenlose 2']);
  this.executeCharTest('𝟥', ['serifenlose 3']);
  this.executeCharTest('𝟦', ['serifenlose 4']);
  this.executeCharTest('𝟧', ['serifenlose 5']);
  this.executeCharTest('𝟨', ['serifenlose 6']);
  this.executeCharTest('𝟩', ['serifenlose 7']);
  this.executeCharTest('𝟪', ['serifenlose 8']);
  this.executeCharTest('𝟫', ['serifenlose 9']);
  this.executeCharTest('𝟬', ['serifenlose fette 0']);
  this.executeCharTest('𝟭', ['serifenlose fette 1']);
  this.executeCharTest('𝟮', ['serifenlose fette 2']);
  this.executeCharTest('𝟯', ['serifenlose fette 3']);
  this.executeCharTest('𝟰', ['serifenlose fette 4']);
  this.executeCharTest('𝟱', ['serifenlose fette 5']);
  this.executeCharTest('𝟲', ['serifenlose fette 6']);
  this.executeCharTest('𝟳', ['serifenlose fette 7']);
  this.executeCharTest('𝟴', ['serifenlose fette 8']);
  this.executeCharTest('𝟵', ['serifenlose fette 9']);
  this.executeCharTest('𝟶', ['nichtproportionale 0']);
  this.executeCharTest('𝟷', ['nichtproportionale 1']);
  this.executeCharTest('𝟸', ['nichtproportionale 2']);
  this.executeCharTest('𝟹', ['nichtproportionale 3']);
  this.executeCharTest('𝟺', ['nichtproportionale 4']);
  this.executeCharTest('𝟻', ['nichtproportionale 5']);
  this.executeCharTest('𝟼', ['nichtproportionale 6']);
  this.executeCharTest('𝟽', ['nichtproportionale 7']);
  this.executeCharTest('𝟾', ['nichtproportionale 8']);
  this.executeCharTest('𝟿', ['nichtproportionale 9']);
  this.executeCharTest('🄁', ['0 Komma']);
  this.executeCharTest('🄂', ['1 Komma']);
  this.executeCharTest('🄃', ['2 Komma']);
  this.executeCharTest('🄄', ['3 Komma']);
  this.executeCharTest('🄅', ['4 Komma']);
  this.executeCharTest('🄆', ['5 Komma']);
  this.executeCharTest('🄇', ['6 Komma']);
  this.executeCharTest('🄈', ['7 Komma']);
  this.executeCharTest('🄉', ['8 Komma']);
  this.executeCharTest('🄊', ['9 Komma']);
...
sre.ClearspeakCharGermanTest.prototype.testClearspeakFunctions = function() {
  ...
  this.executeCharTest('gcd', ['ggt']);
  this.executeCharTest('lcm', ['kgv']);
...
sre.ClearspeakCharGermanTest.prototype.testClearspeakUnits = function() {
