...
export type ConfigMethod = (c: ParserConfiguration, j: any) => void;
...
export class ParserConfiguration {
   ...
   */
  public add(name: string, jax: any, options: OptionList = {}) {
  ...
  */
   ...
   */
  private addFilters(jax: any, config: Configuration) {
